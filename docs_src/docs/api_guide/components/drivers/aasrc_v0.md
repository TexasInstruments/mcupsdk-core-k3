...
\snippet Aasrc_sample.c include

Instance & Channel Open Example
\snippet Aasrc_sample.c open

Instance Close Example
\snippet Aasrc_sample.c close

Start Aasrc Transfer Example
\snippet Aasrc_sample.c start_aasrc_conversion

Stop Aasrc Transfer Example
\snippet Aasrc_sample.c stop_aasrc_conversion

Callback Function Example
\snippet Aasrc_sample.c aasrc_callback_functions

## API

\ref DRV_AASRC_MODULE
