# Performance of Ethernet AVB {#EAVB_PERFORMANCE}
[TOC]
# Introduction
...
# Setup Details
The \ref EXAMPLES_ENET_CPSW_AVB_AUDIO_DEMO is used to obtain the performance numbers.
...
\imageStyle{eavb_latency_diagram.png,width:90%}
\image html eavb_latency_diagram.png
...
For More details, refer to \ref EXAMPLES_ENET_AVB_MULTISTREAM_MCR
