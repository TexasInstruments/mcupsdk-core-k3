# Ethernet Firmware {#NETWORKING_ETHFW}
...
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
## Master Core - EthFw Server {#ethfw_master_core}
- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
\image html ethfw-master-core.png
...
## Remote Cores - Ethfw Client {#ethfw_remote_core}
...
\image html EthFw_component_sitara.png
...
## Physical and Virtual ports {#port_info}
...
## Intercore Ethernet using Shared Memory {#ethfw_intercore_eth}
...
<center>
![](Intercore_eth_topology_overview_sitara.png "Inter-core Virtual Ethernet Topology")
</center>
...
-# <b>A72 Linux client</b>: This is the EthFw Linux remote client.s
...
## Intercore Ethernet using VEPA {#ethfw_intercore_vepa}
...
<center>
![](Intercore_eth_topology_vepa_sitara.png "Inter-core Virtual Ethernet Topology with VEPA")
</center>
