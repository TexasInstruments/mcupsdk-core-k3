# Ethernet Features {#NETWORKING_FEATURES}
...
\cond SOC_AM62PX || SOC_AM62LX || SOC_AM62X
| Feature | Description |
|---------|-------------|
|Basic L2 Switching|Ethernet packet switching with 10M/100M/1G Bandwidth with Multicast and VLAN Capability|
|L3 switching with LwIP Stack|TCP/IP and UDP protocol integration with LwIP|
...
\endcond
\cond SOC_AM62LX || SOC_AM62DX || SOC_AM62X
<table>
<tr><th>Example</th><th>Reference</th></tr>
<tr><td>TCP server</td><td>\ref EXAMPLES_ENET_LWIP_CPSW_TCPSERVER</td></tr>
...
- The SDK provides examples for **AAF PCM, AES3, and CRF subtypes** with talker and listener roles, which are documented in \ref EXAMPLES_NETWORKING_AVB 

For further details, refer to \ref ENET_CPSW_AVTP 
\endcond
