...
You will load and run this example using CCS, as mentioned in \ref CCS_LAUNCH_PAGE.
...
\image html docs_src/docs/api_guide/images/custom_flash/flash_syscfg_gen.png "Flash SysConfig Module GUI" width=30%
...
\image html docs_src/docs/api_guide/images/custom_flash/auto_cfg.png "Flash Auto Config" width=30%
...
\image html docs_src/docs/api_guide/images/custom_flash/long_desc.png "Long Description For Quad Enable Type" width=30%
...
\image html docs_src/docs/api_guide/images/custom_flash/quirks.png "Custom Protocol and Quirks Function Hooks" width=30%
