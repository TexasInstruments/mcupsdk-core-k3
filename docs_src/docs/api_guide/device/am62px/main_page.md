...
\imageStyle{block_diagram_am62px.png,width:70%}
\image html block_diagram_am62px.png "Software Block Diagram"
...
<tr>
    ...
    <td>CLANG based ARM compiler from TI for ARM R5F and MCU-R5F
</tr>
<tr>
    <td>SysConfig
