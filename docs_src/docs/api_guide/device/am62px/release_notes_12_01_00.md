...
<tr>
    ...
    <td> USB
    <td> N/A
    <td> USB is not supported in AM62Px MCU+SDK
</tr>
<tr>
    <td> i2410
...
<tr>
    <td> i2103
    <td> Safety Modules: Incorrect Reporting of ECC_GRP, ECC_BIT and ECC_TYPE Information for Functional Safety Errors
...
<tr>
    ...
    <td> CSI_RX
    <td> N/A
    <td> CSI_RX is not supported in AM62Px MCU+SDK
</tr>
<tr>
    <td> i2196
...
<tr>
    ...
    <td> Boot
    <td> Open
    <td> uart_uniflash.py and uart_bootloader.py do not implement the 50ms inter-character delay workaround
</tr>
<tr>
    <td> i2458
    <td> MMCSD: eMMC HS400 tDCD timing marginal to JEDEC spec
    <td> MMCSD
    <td> Implemented
    <td> SDK uses HS200 mode for eMMC; HS400 mode is not used, avoiding the tDCD timing issue
</tr>
<tr>
    <td> i2464
...
<tr>
    ...
    <td> LPM
    <td> Implemented
    <td> Workaround implemented in SDK 11.1 and later; ensures DDR retention latch is in correct state through reset scenarios
</tr>
</table>
