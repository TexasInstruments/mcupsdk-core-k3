...
\imageStyle{block_diagram_j722s.png,width:70%}
\image html block_diagram_j722s.png "Software Block Diagram"
...
Given below are the paths where the different tools needed outside the SDK, like CCS, SysConfig.
...
<tr>
    <td>${HOME}/ti/ccs@VAR_CCS_FOLDER_VERSION
    <td>Code Composer Studio</td>
</tr>
<tr>
    <td>${HOME}/ti/sysconfig_@VAR_SYSCFG_VERSION
    <td>SysConfig. **NOTE**, SysConfig is also installed as part of CCS at ${CCS_INSTALL_PATH}/ccs/utils/sysconfig_x.x.x</td>
</tr>
<tr>
    <td>${HOME}/ti/ti-cgt-armllvm_@VAR_TI_ARM_CLANG_VERSION
    <td>TI ARM CLANG compiler tool chain</td>
</tr>
<tr>
    <td>${HOME}/ti/ti-cgt-c7000_@VAR_TI_C7000_CGT_VERSION
    <td>C7000 compiler tool chain</td>
</tr>
<tr>
    <td>${HOME}/ti/gcc-arm-@VAR_GCC_AARCH64_VERSION
