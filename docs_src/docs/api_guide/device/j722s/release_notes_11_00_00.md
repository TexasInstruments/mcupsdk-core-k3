...
Feature                                                                                                     | Module
------------------------------------------------------------------------------------------------------------|-----------------------------------
Support for configuring QoS                                                                                 | SBL
Secure Boot support (HS-SE device)                                                                          | SBL
Support S/W Image Version Check                                                                             | SBL
Support for a blocking version of Udma_chDisable API                                                        | UDMA
data correctness check support in DSS driver                                                                | DSS
freeze frame detect support in DSS driver                                                                   | DSS
DSI support in DSS driver                                                                                   | DSS
