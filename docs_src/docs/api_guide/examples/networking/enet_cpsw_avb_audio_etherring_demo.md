# Ethernet AVB Audio Playback and Etherring Demo {#EXAMPLES_ENET_AVB_AUDIO_ETHERRING_DEMO}
...
\imageStyle{audio_etherring_setup.png,width:60%}
\image html audio_etherring_setup.png Audio Etherring Demo Setup

# Audio Traffic Overview
\imageStyle{audio_etherring_avb.png,width:60%}
\image html audio_etherring_avb.png Audio over eAVB Traffic Overview

# Control Traffic Overview
\imageStyle{audio_etherring_control.png,width:60%}
\image html audio_etherring_control.png Control eAVB Traffic Overview

# Background Traffic Overview
\imageStyle{audio_etherring_background.png,width:60%}
\image html audio_etherring_background.png Background Traffic overview
...
- Since this demo uses 4 AM275 EVMs, for the ease of use, it is recommended to go with the SD Boot instead of loading from CCS. For more information on how to use SD Boot refer to the \ref EXAMPLES_DRIVERS_SBL_SD page.
