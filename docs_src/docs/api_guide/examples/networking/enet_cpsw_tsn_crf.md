# Ethernet CRF Master Example {#EXAMPLES_ENET_CPSW_TSN_CRF_MASTER}
...
- Start ptp4l on PC as master. Refer to \ref EXAMPLES_ENET_CPSW_TSN_GPTP to setup PC as gptp master.
