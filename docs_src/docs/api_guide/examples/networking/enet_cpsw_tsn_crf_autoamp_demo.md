# Ethernet Autoamplifer with CRF Demo {#EXAMPLES_ENET_CPSW_TSN_CRF_AUTOAMP_DEMO}
...
\imageStyle{autoamp_demo.png,width:50%}
\image html autoamp_demo.png
...
\image html autoampdemo_setup.png
