...
:::{admonition} Note
Please refer `DRV_MCAN_MODULE` for more details and [Example Usage](mcan.md) for code snippets.
:::
...
```{figure} ../../images/drivers/mcan_bit_timing.PNG
:align: center
:alt: MCAN Bit Timing Diagram
...
```{literalinclude} ../../../../docs/api_guide/doxy_samples/drivers/Mcan_sample.c
:language: c
:lines: 8-8
```
