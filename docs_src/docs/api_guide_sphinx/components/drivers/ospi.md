...
:::{only} SOC_AM62X or SOC_AM62DX or SOC_AM62PX or SOC_AM275X or SOC_AM62LX or SOC_J722S
   :::{admonition} Note
   The DQS tuning algorithm has been updated from a window based search to a more robust diagonal based search. Refer [OSPI Phy Tuning Algorithm](ospi.md) for updated tuning algo implementation. :::
   :::
...
```{figure} ../../images/drivers/ospi_phy_configuration.png
:align: center
:alt: OSPI PHY Configurations Syscfg
...
```{figure} ../../images/drivers/ospi_default_params_ddr.png
:align: center
:alt: OSPI DQS DEFAULT PARAMS

OSPI DQS DEFAULT PARAMS
```

```{figure} ../../images/drivers/ospi_fast_tuning_params_ddr.png
:align: center
:alt: OSPI DQS FAST TUNING PARAMS
...
```{figure} ../../images/drivers/ospi_default_window_params_sdr.png
:align: center
:alt: OSPI Non-DQS DEFAULT PARAMS

OSPI Non-DQS DEFAULT PARAMS
```

```{figure} ../../images/drivers/ospi_fast_tuning_window_params_sdr.png
:align: center
:alt: OSPI Non-DQS FAST TUNING PARAMS

OSPI Non-DQS FAST TUNING PARAMS
```
...
```{figure} ../../images/drivers/ospi_diagonal_selection.png
:align: center
:alt: Diagonal Selection
...
```{figure} ../../images/drivers/ospi_read_delay_selection.png
:align: center
:alt: Read Delay Selection
...
```{figure} ../../images/drivers/ospi_corner_point_selection.png
:align: center
:alt: Corner Point Selection
...
```{figure} ../../images/drivers/ospi_only_one_read_delay.png
:align: center
:alt: Corner Point Selection for One Read Delay
...
```{figure} ../../images/drivers/ospi_two_different_read_delay.png
:align: center
:alt: Corner Point Selection for Two Different Read Delays
...
```{figure} ../../images/drivers/ospi_tuning_point_selection.png
:align: center
:alt: Tuning Point Selection at Midpoint
...
```{figure} ../../images/drivers/ospi_tuning_point_selection_2.png
:align: center
:alt: Tuning Point Selection at Midpoint of Larger Segment
...
<table>
    ...
    <tr>
        <td><code>OSPI_setDeviceSize</code>
        <td>New param deviceSize added
    </tr>
    <tr>
        <td><code>OSPI_phyTuneGrapher</code>
...
The transfer timeout is configurable per-transaction via the `transferTimeout` field in `OSPI_Transaction`, as shown below:
...
```{literalinclude} ../../../../docs/api_guide/doxy_samples/drivers/Ospi_sample.c
:language: c
:lines: 3-4
```
...
Refer to the OSPI driver header file for detailed API information.
