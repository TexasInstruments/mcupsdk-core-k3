...
- The translation API `AddrTranslateP_getLocalAddr` is meant to be used to translate SOC specified peripheral MMR base
...
::::{only} SOC_AM64X or SOC_AM243X or SOC_AM62AX or SOC_AM62DX
...
::::{only} SOC_AM64X or SOC_AM243X or SOC_AM62X
