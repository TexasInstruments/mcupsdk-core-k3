...
![Difference in architecture of a traditional Microcontroller and a typical high-performance microcontroller like AM2x. Note that, there is no embedded flash.](../../images/optiflash/architecture_of_high_performance_mcu.png)
...
![OptiFlash technology Ecosystem](../../images/optiflash/optiflash_entire.png)
...
![AM2x devices with OptiFlash technology. Blocks marked in RED are specifically put to improve XIP performance.](../../images/optiflash/am275x_perf.png)
...
![FLC HWA or FLC hardware Accelerator, would fetch an instruction from faster internal memory, if available, else would get it from external Flash.](../../images/optiflash/flc_lookup_function.png)
