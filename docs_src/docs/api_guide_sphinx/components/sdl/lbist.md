...
::::{only} SOC_AM62PX
   ...
   :::{admonition} Note
   The above numbers were obtained in the wkup-r5fss0-0_freertos setting
   :::
...
::::{only} SOC_AM275X
   ...
   :::{admonition} Note
   The above numbers were obtained in the r5fss0-0_nortos and r5fss1-0_nortos settings respectively
   :::
...
```{doxygenfile} sdl/lbist/v0/sdl_ip_lbist.h
```
