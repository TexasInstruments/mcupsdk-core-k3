...
::::{only} SOC_AM62X
   ...
   :::{admonition} Note
   The above numbers were obtained in the m4fss0-0_nortos setting
   :::
...
::::{only} SOC_AM275X
   ...
   :::{admonition} Note
   The above numbers were obtained in the r5fss0-0_nortos setting
   :::
