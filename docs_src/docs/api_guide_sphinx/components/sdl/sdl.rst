...
.. only:: SOC_AM62X or SOC_AM62AX or SOC_AM62DX or SOC_AM62PX or SOC_AM275X
   ...
   - :doc:`DCC <dcc>` - Dual Clock Comparator
   - :doc:`DPL <sdl_dpl>` - Driver Porting Layer for SDL
   - :doc:`ECC <ecc>` - Error Correcting Code
   - :doc:`ESM <esm>` - Error Signaling Module
   - :doc:`LBIST <lbist>` - Logic Built-In Self Test
   - :doc:`MCRC <mcrc>` - Memory Cyclic Redundancy Check

   .. only:: not SOC_AM275X

      - `MTOG <mtog.html>`__ - Module Toggle

   - :doc:`PBIST <pbist>` - Memory Built-In Self Test
   - :doc:`POK <pok>` - Power OK
   - :doc:`ROM Checksum <rom_checksum>` - ROM Checksum
   - :doc:`RTI <rti>` - Real Time Interrupt Watchdog

   .. only:: not SOC_AM275X

      - `STOG <stog.html>`__ - Stog

   - :doc:`VTM <vtm>` - Voltage and Thermal Monitor
   ...
   .. only:: SOC_AM62X
      ...
      `Request CSP <https://www.ti.com/secureresources/AM62X-RESTRICTED-DOCS-SAFETY>`__

   .. only:: SOC_AM62AX

      `Request CSP <https://www.ti.com/secureresources/AM62A-RESTRICTED-DOCS-SAFETY>`__

   .. only:: SOC_AM62PX

      `Request CSP <https://www.ti.com/secureresources/AM62P-RESTRICTED-DOCS-SAFETY>`__

   .. only:: SOC_AM62DX

      `Request CSP <https://www.ti.com/secureresources/AM62D-RESTRICTED-DOCS-SAFETY>`__

   .. only:: SOC_AM275X

      `Request CSP <https://www.ti.com/secureresources/AM275-RESTRICTED-DOCS-SAFETY>`__
   ...
   Other official documentation for your device, such as User Guide, Errata, TÜV SÜD SDL certification (for applicable devices) etc. may be found on the corresponding |VAR_SOC_NAME| product page on ti.com.
