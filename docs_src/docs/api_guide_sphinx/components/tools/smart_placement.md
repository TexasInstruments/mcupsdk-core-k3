...
:::{only} SOC_AM275X
 ...
 MSRAM      |0x72080000           | 6 MB
 FLASH      |0x60000000           | External Flash (OSPI)
:::
...
![](../../images/smart_placement/perf_graph.drawio.png)
...
There are many ways to determine critical function. They are provided and can be read at [Getting Started With Smart Placement](../../getting_started/getting_started_smart_placement.md). Reason of providing this is to make smart placement more usable.
...
:::{only} SOC_AM275X
![](../../images/smart_placement/smart_placement_am275x.png)
:::
...
To get started with smart placement, please go through [Getting Started With Smart Placement](../../getting_started/getting_started_smart_placement.md)
