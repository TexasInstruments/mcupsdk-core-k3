...
<tr>
    <td>xipGen/
    <td>Tool to split a RPRC file generated from <code>out2rprc</code> into two files containing non-XIP and XIP sections.
</tr>
<tr>
...
<tr>
    <td>uart_uniflash.py
    <td>Python script used to flash SBL and applications to EVM flash using UART. See <a href="tools_flash.html">Flashing Tools</a> for more details.
</tr>
::::
...
**MCELF Image Gen**
   ...
   - Shown below is the file format for an mcelf image file and its metacontent as seen by `readelf`
     ...
     ![MCELF Image File Format](../../images/am275x/tools_mcelf_format.png)
...
::::{only} SOC_AM64X or SOC_AM243X or SOC_AM62X or SOC_AM62AX or SOC_AM62DX or SOC_AM62PX or SOC_AM62LX or SOC_AM263X or SOC_AM273X or SOC_AWR294X or SOC_J722S
...
## Out2RPRC
   ...
   - Shown below is the file header and section format for RPRC files.
       ...
       ![RPRC File Format](../../images/tools/tools_rprc_format.png)
...
## Multi-core Image Gen
   ...
   - Shown below is the file format for multicore image files.
     ...
     ![Multi-core Image File Format](../../images/tools/tools_multicore_format.png)
...
:::{only} SOC_AM62X or SOC_AM62AX or SOC_AM62DX or SOC_AM62PX
   For more details about this see [Enabling Secure Boot](../../developer_guides/secure_boot.md)
:::
...
**XIP Image Generator Tool**
   ...
   - The final number of sections in both RPRC files taken together can be less
     ...
     ![XIP Image Generation Tool flow](../../images/tools/tools_xip_gen.png)
...
:::::{only} SOC_AM64X or SOC_AM62X or SOC_AM62AX or SOC_AM62PX or SOC_J722S or SOC_AM62DX
...
- The input file names for ATF, OPTEE and SPL can also be mentioned in the `config.mak` file.
  - `#Input linux binaries`\n
    `ATF_BIN_NAME=bl31.bin`\n
    `OPTEE_BIN_NAME=bl32.bin`\n
    `SPL_BIN_NAME=u-boot-spl.bin-am62dxx-evm`\n
::::
...
::::{only} SOC_AM62X
:::{admonition} Note
In case of **AM62x SIP** board, the load address for ATF, OPTEE and SPL is:
- `#Linux image load address`\n
  `ATF_LOAD_ADDR=0x80000000`\n
  `OPTEE_LOAD_ADDR=0x80080000`\n
...
:::::{only} SOC_AM62X or SOC_AM62AX or SOC_AM62PX or SOC_AM62DX or SOC_AM275X or SOC_J722S
...
::::{only} SOC_AM62X or SOC_AM62AX or SOC_AM62DX or SOC_AM62PX or SOC_AM64X or SOC_AM243X or SOC_AM263X or SOC_AM273X or SOC_AWR294X
:::{admonition} Attention
GCC AARCH64 compiler installation is required for HSM appimage generation. Refer [GCC AARCH64 Compiler](../../getting_started/download_and_install.md)
:::
::::
