# Enabling XIP or eXecute In Place
...
- To understand and run a example in XIP mode see
  - [XIP Benchmark](../examples/benchmarks/xip_benchmark.md)
- To understand overall boot flow see, [Understanding the bootflow and bootloaders](bootflow.md)
...
![Flash section in R5F MPU](../images/bootflow/bootflow_xip_mpu_setup.png)
...
![CCS Load Symbols](../images/bootflow/bootflow_xip_load_symbols.png)
...
![HW Breakpoint](../images/bootflow/bootflow_xip_hw_break_point.png)
