...
::::{only} SOC_AM62DX
   :::{admonition} Note
   There is a known CCS issue of being unable to connect to any core when using AM62D as the **Board or Device** in the **Target Configuration**
   :::

   :::{admonition} Note
   **Workaround**: - Create a new **Target Configuration**, under *Basic configuration* select **AM62A** as the **Board or Device**
   :::
...
::::{only} SOC_AWR294X or SOC_AM243X or SOC_AM64X or SOC_AM273X or SOC_AM263X or SOC_AM62X or SOC_AM62AX or SOC_AM62LX or SOC_AM62PX
   :::{admonition} Note
   For an existing project, manually add the following entry in the **syscfg_c.rov.xs** already present in the project
...
- To launch ROV, click on `CCS Menu > View > Runtime (RTOS) Objects' as shown below
    ...
    ```{figure} ../images/ccs_rov_theia/rov_launch.png
    :align: center
...
- This will launch the ROV viewer as shown below
    ...
    ```{figure} ../images/ccs_rov_theia/rov_supported_features.png
    :align: center
...
- It is **HIGHLY recommended** to create your custom project using the [Empty Project](../examples/examples_empty.md) included in the SDK. This will provide the normal project settings along with ROV supported enable in your project
