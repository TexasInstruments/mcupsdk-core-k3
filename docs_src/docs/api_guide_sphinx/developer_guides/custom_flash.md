...
## Summary of steps needed to enable a new flash device
 ...
 - **Step 1**: Build the `ospi_flash_diag` example : [OSPI Flash Diagnostic](../examples/drivers/ospi_flash_diag.md).
...
Refer the example page [OSPI Flash Diagnostic](../examples/drivers/ospi_flash_diag.md) on building this application.
You will load and run this example using CCS, as mentioned in [CCS Launch, Load and Run](../getting_started/ccs_launch.md).
...
```{figure} ../images/custom_flash/flash_syscfg_gen.png
:align: center
...
```{figure} ../images/custom_flash/auto_cfg.png
:align: center
**Flash Auto Config**
```
...
```{figure} ../images/custom_flash/long_desc.png
:align: center
...
```{figure} ../images/custom_flash/quirks.png
:align: center
