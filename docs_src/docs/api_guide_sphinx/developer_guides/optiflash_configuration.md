# Configuring OptiFlash various IP
...
```{figure} ../images/optiflash_configurations/flc_syscfg_initial.png
:align: center
:width: 50%
```
...
- In linker file you have to set isrl2 to true.
...
```{figure} ../images/optiflash_configurations/syscfg.png
:align: center
:width: 50%
```
