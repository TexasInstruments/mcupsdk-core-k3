...
![OptiShare Summary](../../images/optishare_summary_1.png)
...
[IPC Notify Echo Example With OptiShare](../../examples/drivers/ipc_notify_echo_optishare.md) is an example in SDK which implements OptiShare.
...
![Space Saving with Optishare](../../images/optishare_solution_1.png)
...
![Optishare Flow](../../images/optishare_flow.png)
...
![RAT Hardware being used for Optishare](../../images/optiflash_rat_.png)
...
![Optishare Runtime](../../images/optishare_runtime.png)
...
Here [IPC Notify Echo Example With OptiShare](../../examples/drivers/ipc_notify_echo_optishare.md) example is being used.
...
![Optishare link time flags](../../images/optishare_link_flags.png)
...
![Relinking of binary](../../images/coreout_rule.png)
...
![Memory Map of Shared Region](../../images/shared_memory_map.png)
...
![MPU Of Shared Region](../../images/shared_memory_memory.png)
...
In the [IPC Notify Echo Example With OptiShare](../../examples/drivers/ipc_notify_echo_optishare.md) example, the file is defined as:
...
![Run time code changes block diagram](../../images/runtime_code_changes_blockdiagram.png)
...
MulticcoreELF ([Understanding Multicore ELF image format](../mcelf_landing_page.md)) is the image format that SDK uses to boot from flash. The genimage.py script takes in `.out` files of cores and provides `.mcelf` output.
