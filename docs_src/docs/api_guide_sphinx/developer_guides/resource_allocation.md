...
![Resource Allocation](../images/sciclient/respart_tool_res.png)
...
- You can decrease/increase the number of resources.There are hard
  ...
  allowed number.
![Resource Exceeding Allowed Limits](../images/sciclient/respart_tool_error.png)
...
![Resource Allocation Entry](../images/am62dx/respart_tool_sharing_start.png)


- After the resource is shared, it will show up as an info under the resource.
![Resource Allocation Info](../images/sciclient/respart_tool_sharing.png)
...
:::{admonition} Note
For more information about the K3 Resource Configuration tool and the generated files, please refer to the [K3 Resource Configuration User's Guide](https://dev.ti.com/tirex/content/tirex-product-tree/processors-utilities_1_0_0/k3_resource_configuration_users_guide.html).
:::
