...
:::{note}
See also TOOLS_FLASH for more details on the flashing tools.
:::
...
- Build the hello world application as mentioned in GETTING_STARTED_BUILD
...
![Flash in progress](../../images/am275x/flash_sbl_ospi_nand_in_progress.png)
