...
To get started, see [Getting Started](../../getting_started/getting_started_am275x.md)

## Block Diagram

Given below is a block diagram of the SW modules in this SDK,
![Software Block Diagram](../../images/am275x/block_diagram_am275x.png)
...
|---------------------------------------|------------------------------------------------------------------------------------------------------|
| **${SDK_INSTALL_PATH}/**              |                                                                                                      |
| README_FIRST_AM275X.html              | Open this file in a web browser to reach this user guide                                             |
...
| examples/                             | Example applications for AM275X, across multiple boards, CPUs, NO-RTOS, RTOS                        |
...
A complete manifest along with export control information is detailed here <a href="../../../freertos_sdk_am275x_manifest.html">LINK</a>
