...
- Make sure you have **Snagboot** installed on your host PC. Snagfactory is available on pip and can be installed using:
...
- After all the flashing is done, you will see something like below:
        ...
        [INFO] Sending DFU_DETACH...
        [INFO] Done installing firmware u-boot
        [INFO] Done recovering am62p board
...
```{figure} ../../images/am62px/ccs_uart_close.png
:align: center
...
:::{admonition} Note
For am62px-sk HS-SE device, use default_sbl_ospi_linux_hs.cfg as the cfg file.
:::

:::{admonition} Note
For am62px-sk HS-FS device, use default_sbl_ospi_linux_hs_fs.cfg as the cfg file.
:::
...
```{figure} ../../images/am62px/boot_pins_ospi_mode.png
:align: center
