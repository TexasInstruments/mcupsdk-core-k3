...
Please read more on smart placement at [Smart Placement](../../components/tools/smart_placement.md), before moving further ahead.
...
To know more about the software instrumentation flow, please refer to [Software Instrument Smart Placement](../../components/tools/sw_instrument_smart_placement.md).
...
Flash this application using uart_uniflash. For this please go through [Flashing Tools](../../components/tools/tools_flash.md)
