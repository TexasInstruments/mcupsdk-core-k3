...
- Now flash to EVM using the steps mention here, only use the config file mentioned above, [Flash a Hello World example](../../getting_started/getting_started_flash.md)
