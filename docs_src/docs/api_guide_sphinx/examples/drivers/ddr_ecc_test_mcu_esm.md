...
- Flash SBL NULL bootloader by following steps mentioned in [EVM Setup](../../device/am62ax/am62ax_evm_setup.md)
- Switch to [EVM Setup](../../device/am62ax/am62ax_evm_setup.md) and power on the EVM.
