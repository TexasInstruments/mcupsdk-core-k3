...
::::{only} SOC_AM62X
   :::{admonition} Attention
   For {{ VAR_BOARD_NAME }}, Board ID EEPROM address is 0x51u.
   :::
   ...
   MCU_I2C0 can be connected to Board ID EEPROM through making the following jumper connections as shown in the image.
    ...
    - Connect Pin 24 of J9 (MCU_I2C0_SCL) to Pin 28 of J3.
     ...
     ```{figure} ../../images/am62x/i2c_read_am62x_sk.png
     :align: center
...
::::{only} SOC_AM275X
   ...
   MCU_I2C0 can be connected to Board ID EEPROM through making the following jumper connections as shown in the image.
    ...
    - Connect Pin 24 of J9 (MCU_I2C0_SCL) to Pin 28 of J3.
     ...
     ```{figure} ../../images/am275x/i2c_read_am275x.png
     :align: center
...
::::{only} SOC_AM62PX
   ...
   - Connect Pin 24 of J9 (MCU_I2C0_SCL) to Pin 28 of J3.
     ...
     ```{figure} ../../images/am62px/i2c_read_am62px_sk.png
     :align: center
...
::::{only} SOC_AM62X or SOC_AM62AX or SOC_AM62DX or SOC_AM62PX
   To modify the example to use main/wakeup domain I2C, refer [Accessing main and wakeup domain peripherals from MCU domain](../../developer_guides/main_domain_peripheral_access.md)
::::
