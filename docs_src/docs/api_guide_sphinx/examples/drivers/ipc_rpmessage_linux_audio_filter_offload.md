...
- This example provides support for graceful shutdown of the core (C7). Refer [Graceful Remote Core Shutdown](../../developer_guides/graceful_remotecore_shutdown.md) for more details.
...
`cascadeBiquad0CoeffCase5` array in `${SDK_INSTALL_PATH}/examples/drivers/ipc/ipc_rpmsg_linux_audio_filter_offload/am62dx-evm/c75ss0-0_freertos/ti-c7000/TISP_cascadeBiquad_FIR_test.cpp` handles the coefficients that determines the cut-off and type of this filter.
...
`cascadeBiquad1CoeffCase5` array in `${SDK_INSTALL_PATH}/examples/drivers/ipc/ipc_rpmsg_linux_audio_filter_offload/am62dx-evm/c75ss0-0_freertos/ti-c7000/TISP_cascadeBiquad_FIR_test.cpp` handles the coefficients that determines the cut-off and type of this filter.
...
`filterCoeffCase5` array in `${SDK_INSTALL_PATH}/examples/drivers/ipc/ipc_rpmsg_linux_audio_filter_offload/am62dx-evm/c75ss0-0_freertos/ti-c7000/TISP_cascadeBiquad_FIR_test.cpp` handles the coefficients that determines the cut-off and type of this filter.
