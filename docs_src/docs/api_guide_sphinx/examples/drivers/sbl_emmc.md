...
- Make sure IPC rpms echo application is built before running the flash script. (see [IPC RPMessage Echo](../drivers/ipc_rpmessage_echo.md))

- To flash to the EVM, refer to [Getting Started Flash](../../getting_started/getting_started_flash.md). Only when giving the flash config file, point to the `sbl_emmc_hs_fs.cfg` shown above.
