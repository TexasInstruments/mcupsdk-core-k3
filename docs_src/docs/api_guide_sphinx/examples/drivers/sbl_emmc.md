...
- To flash to the EVM, refer to [GETTING_STARTED_FLASH](#getting_started_flash) . Only when giving the flash config file, point to the `sbl_emmc_hs_fs.cfg` shown above.
