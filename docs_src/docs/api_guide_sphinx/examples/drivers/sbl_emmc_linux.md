...
- To flash to the EVM, refer to [GETTING_STARTED_FLASH](#getting_started_flash) . Only when giving the flash config file, point to the `default_sbl_emmc_linux.cfg` shown above.
