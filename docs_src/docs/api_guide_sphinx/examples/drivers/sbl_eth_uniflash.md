...
![](../../images/am275x/boot_pins_eth_mode.jpg)

:::{note}
Do not connect UART_CONN USB Connector on the EVM, This modifies the Boot selection signals causing the RBL to not boot from Ethernet.
:::
