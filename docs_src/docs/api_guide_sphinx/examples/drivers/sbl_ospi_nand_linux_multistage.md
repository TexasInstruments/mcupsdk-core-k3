...
::::{only} SOC_AM62X
   ...
   - To flash to the EVM, refer to [Flash a Hello World example](../../getting_started/getting_started_flash.md) . Only when giving the flash config file, point to the `default_sbl_ospi_nand_linux.cfg` shown above.
...
::::{only} SOC_AM62AX or SOC_AM62DX
   ...
   - To flash to the EVM, refer to [Flash a Hello World example](../../getting_started/getting_started_flash.md) . Only when giving the flash config file, point to the `default_sbl_ospi_nand_linux_hs_fs.cfg` shown above.
...
::::{only} SOC_AM62X
   :::{admonition} Note
   The above config file will flash till u-boot on the OSPI NAND bootmedia. U-Boot can load kernel from any bootmedia, refer to [**Processor SDK Linux**](https://software-dl.ti.com/processor-sdk-linux/esd/AM62X/latest/exports/docs/devices/AM62X/linux/Overview.html) user guide for more details.
   :::
   :::
...
::::{only} SOC_AM62AX or SOC_AM62DX
   :::{admonition} Note
   The above config file will flash till u-boot on the OSPI NAND bootmedia. U-Boot can load kernel from any bootmedia, refer to [**Processor SDK Linux**](https://software-dl.ti.com/processor-sdk-linux/esd/AM62AX/latest/exports/docs/devices/AM62AX/linux/Overview.html) user guide for more details.
   :::
   :::
