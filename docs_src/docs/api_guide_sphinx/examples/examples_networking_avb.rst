...
.. only:: SOC_AM62DX
   ...
   - :doc:`Enet CPSW AVTP Example <networking/enet_cpsw_avtp_example>`
   - :doc:`Enet TSN AVTP AES3 AAF App <networking/enet_tsn_avtp_aes3_aaf_example>`
   - :doc:`Enet CPSW TSN CRF Master <networking/enet_cpsw_tsn_crf>`
