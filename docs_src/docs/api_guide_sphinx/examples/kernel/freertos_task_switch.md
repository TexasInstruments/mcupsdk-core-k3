...
::::{only} SOC_AM62X
   - To run the example on a53ss0-0, a53ss0-1, a53ss1-0 and a53ss1-1 in FreeRTOS-AMP mode, run the task_switch_freertos-amp_sbl_uart_hs_fs.cfg file using [SBL UART](../drivers/sbl_uart.md) or load and run through CCS individually
::::
