...
::::{only} SOC_AM273X
:::{admonition} Warning
AM273x is single ethernet port device and hence gPTP Bridge mode is not possible to execute
:::
::::
...
On PC1, change the value of `priority1` in ~/gptp_config.cfg file to `100`, to enforce PC1 to gPTP master.
:::

:::{admonition} Attention
On PC2, change the value of `priority1` in ~/gptp_config.cfg file to `255`, to enforce PC2 to gPTP slave.
:::
...
<!-- IMAGE NOT FOUND: am64x_evm_lwip_example_00.png -->
:::
...
<!-- IMAGE NOT FOUND: am243x_lp_lwip_example_00.png -->
:::
...
![Local network between PC and EVM](../../images/networking/gptp_topology_pc_evm_pc.png)
