...
| CPU + OS | c75ss0-0_freertos (Audio data sink) |
| Toolchain | ti-arm-clang |
| Board | {{ VAR_BOARD_NAME_LOWER }} |
| Example folder | source/networking/ethfw/apps/app_remoteswitchcfg_server/sitara/avb_audio_source |
| Example folder | source/networking/ethfw/apps/app_remoteswitchcfg_server/sitara/avb_audio_sink |
...
::::{only} SOC_AM62DX
   ...
   ```{figure} ../../images/examples/ethfw_am62dx_setup.png
   :align: center

   **Ethernet Firmware AM62DX Setup**
   ```
::::
...
```{figure} ../../images/examples/ethfw_portCfg_am62dx.png
:align: center
...
::::{only} SOC_AM62PX or SOC_AM62AX
   **Enable MAC-only mode on MAC port 2** {#MAC_ONLY_PORT}
   ...
   ```{figure} ../../images/examples/ethfw_macOnly_script_change.png
   :align: center
   ...
   **MAC Address Setting**
   ...
   ```{figure} ../../images/examples/ethfw_macOnly_ale_config.png
   :align: center
   ...
   **ALE Port Configuration**
   ...
   ```{figure} ../../images/examples/ethfw_macOnly_port_vlan_config.png
   :align: center
   ...
   **VLAN Configuration**
   ...
   ```{figure} ../../images/examples/ethfw_macOnly_netif_changes.png
   :align: center

   **Netif Configuration Changes**
   ```
