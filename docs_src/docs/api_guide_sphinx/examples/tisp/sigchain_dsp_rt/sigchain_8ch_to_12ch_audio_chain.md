...
::::{only} SOC_AM275X
```{figure} ../../../images/am275x/TISP_pe_frequency.png
:align: center
:width: 1000px

**Frequency response of parametric filter (cascade biquad)**
```
::::
::::{only} SOC_AM62DX
...
::::{only} SOC_AM275X
```{figure} ../../../images/am275x/TISP_8ch_to_12ch_audio_signal_chain.svg
:align: center
:width: 90%
...
::::
::::{only} SOC_AM62DX
```{figure} ../../../images/am62dx/TISP_8ch_to_12ch_audio_signal_chain.svg
:align: center
:width: 90%
...
- **Using CCS Projects:** Import the system CCS project and build it using the CCS project menu (see [Using SDK with CCS Projects](../../../developer_guides/ccs_projects.md)). This will build all dependent CPU projects as well.
- **Using Makefiles:** Build the system makefile using the `make` command (see [Using SDK with Makefiles](../../../developer_guides/makefile_build.md)). This will build all dependent CPU makefiles as well.
...
::::{only} SOC_AM275X
```{figure} ../../../images/am275x/TISP_8ch_to_12ch_audio_chain.png
:align: center
:width: 1000px
...
::::
::::{only} SOC_AM62DX
```{figure} ../../../images/am62dx/TISP_8ch_to_12ch_audio_chain.png
:align: center
:width: 1000px
...
::::{only} SOC_AM275X
```{figure} ../../../images/am275x/TISP_8ch_to_12ch_audio_chain_wave.png
:align: center
:width: 1000px
...
::::
::::{only} SOC_AM62DX
```{figure} ../../../images/am62dx/TISP_8ch_to_12ch_audio_chain_wave.png
:align: center
:width: 1000px
