...
:::{admonition} Attention
**Flash Write Address Alignment Requirement**: All flash write operations require the flash offset/address to be aligned to the flash **erase block size**. For example, if the erase block size is 64KB (0x10000 bytes), the flash offset must be a multiple of 0x10000. Using non-block-aligned addresses will result in "Flashing Failed Error". Always ensure that the `--flash-offset` value in your configuration file is block-aligned.
:::
...
::::{only} SOC_AM62PX or SOC_AM62AX or SOC_AM62X
- Set boot mode to **USB DFU BOOTMODE** as shown in the image below:

```{figure} ../images/am62px/boot_pins_dfu_boot_mode.png
:align: center
...
::::{only} SOC_AM62AX
```{figure} ../images/am62ax/snagfactory_flashing.png
:align: center
```
::::
...
::::{only} SOC_AM62AX
```{figure} ../images/am62ax/snagfactory_flash.png
:align: center
```
::::
...
::::{only} SOC_AM62AX
```{figure} ../images/am62ax/snagfactory_cli.png
:align: center
```
::::
...
- After all the flashing is done, you will see terminal output showing the recovery and flashing progress.

- If flashing has failed, resolve the errors and retry.
- If flashing is successful, switch to the appropriate boot mode and power-cycle the EVM.
...
```{figure} ../images/am275x/mmc_interface.png
:align: center

**MMC INTERFACE SELECT**
```
```{figure} ../images/am62ax/boot_pins_uart_boot_mode.png
:align: center
...
**UART BOOT MODE**
```
```{figure} ../images/am62lx/boot_pins_uart_boot_mode.png
:align: center

**UART BOOT MODE**
```
```{figure} ../images/am62px/boot_pins_uart_boot_mode.png
:align: center
...
**UART BOOT MODE**
```
```{figure} ../images/j722s/boot_pins_uart_boot_mode.png
:align: center
...
```{figure} ../images/am275x/uart_rom_boot.png
:align: center

**UART output in UART BOOT MODE**
```
```{figure} ../images/am62ax/uart_rom_boot.png
:align: center
...
**UART output in UART BOOT MODE**
```
```{figure} ../images/am62lx/uart_rom_boot.png
:align: center

**UART output in UART BOOT MODE**
```
```{figure} ../images/am62px/uart_rom_boot.png
:align: center
...
**UART output in UART BOOT MODE**
```
```{figure} ../images/j722s/uart_rom_boot.png
:align: center
...
```{figure} ../images/am275x/flash_sbl_ospi_nand_in_progress.png
:align: center

**Flash in progress**
```
```{figure} ../images/am62ax/flash_sbl_ospi_nand_in_progress.png
:align: center

**Flash in progress**
```
```{figure} ../images/am62dx/flash_sbl_ospi_in_progress.png
:align: center

**Flash in progress**
```
```{figure} ../images/am62lx/flash_soc_init_in_progress.png
:align: center

**Flash in progress**
```
```{figure} ../images/am62px/flash_soc_init_in_progress.png
:align: center
...
```{figure} ../images/am62dx/boot_pins_ospi_nand_mode.png
:align: center
