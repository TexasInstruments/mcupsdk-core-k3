...
More on this can be read at [Manual Smart Placement](../developer_guides/add_smart_placement_sections.md)
...
More on this can be read at [SW Instrumentation Smart Placement](../developer_guides/add_smart_placement_sections.md)
