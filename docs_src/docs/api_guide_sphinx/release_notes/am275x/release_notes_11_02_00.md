...
:::{note}
Update of OSPI tuning algorithm on this SDK causes increase in tuning time. Refer OSPI_DATA_SHEET
:::
...
Example to demonstrate the Jack-Jack latency performance is added(EXAMPLES_ENET_CPSW_AVB_AUDIO_DEMO)    | Ethernet AVB
Sample Ethernet AVB Media Clock Recovery example using external clock generator(CDCE6214) is added                      | Ethernet AVB
Sample Ethernet AVB Media Clock Recovery example using Automotive PHY with clock generator(DP83TG721) is added (EXAMPLES_ENET_AVB_MULTISTREAM_MCR)      | Ethernet AVB
Optimized Jack-Jack Latency performance benchmark is added in datasheet (EAVB_PERFORMANCE)                 | Ethernet AVB
...
<tr>
    <td> [ EXT_SITMPUSW-241](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-241)
...
<tr>
    <td> [ EXT_SITMPUSW-180](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-180)
...
<tr>
    <td> [ EXT_SITMPUSW-218](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-218)
...
<tr>
    <td> [ EXT_SITMPUSW-118](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-118)
...
<tr>
    <td> [ EXT_SITMPUSW-181](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-181)
...
<tr>
    <td> [ EXT_SITMPUSW-240](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-240)
...
<tr>
    <td> [ EXT_SITMPUSW-157](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-157)
...
<tr>
    <td> [ EXT_SITMPUSW-228](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-228)
...
<tr>
    <td> [ EXT_SITMPUSW-120](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-120)
    <td> AM62A/AM275x: C7x task size/alignment should be 8KB (not 16KB)
    <td> C7X
</tr>
<tr>
    <td> [ EXT_SITMPUSW-261](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-261)
...
<tr>
    <td> [ EXT_SITMPUSW-249](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-249)
