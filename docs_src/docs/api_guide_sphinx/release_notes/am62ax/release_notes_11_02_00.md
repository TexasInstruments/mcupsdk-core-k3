...
<tr>
    <td> [ EXT_SITMPUSW-177](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-177)
    <td> Invalid comment in the linker command files
    <td> Build
</tr>
<tr>
    <td> [ EXT_SITMPUSW-243](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-243)
    <td> Debug unlock certificate generation script does not generate DER certificate blob
    <td> Build
</tr>
<tr>
    <td> [ EXT_SITMPUSW-169](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-169)
    <td> C7x Minimum stack size is increased from 10.1 to 11.0 for AM62A, AM62D
    <td> C7X
</tr>
<tr>
    <td> [ EXT_SITMPUSW-178](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-178)
    <td> Incorrect handling of the donedataLen in the SA2UL_contextProcess
    <td> Crypto
</tr>
<tr>
    <td> [ EXT_SITMPUSW-173](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-173)
    <td> Incorrect calculation of ptrInput and ptrOutput in the SA2UL_contextProcess
    <td> Crypto
</tr>
<tr>
    <td> [ EXT_SITMPUSW-269](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-269)
    <td> LPDDR:  DDR PLL reset code issue
    <td> DDR
</tr>
<tr>
    <td> [ EXT_SITMPUSW-245](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-245)
    <td> MCU+ SDK LPDDR4 Driver starts DDR Training/Leveling Sequence twice
    <td> DDR
</tr>
<tr>
    <td> [ EXT_SITMPUSW-293](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-293)
    <td> Sciclient driver uses incorrect context for the TISCI_MSG_KEYRING_IMPORT
    <td> DM
</tr>
<tr>
    <td> [ EXT_SITMPUSW-309](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-309)
    <td> LPM: Spurious wake up on MCU only mode
    <td> DM
</tr>
<tr>
    <td> [ EXT_SITMPUSW-303](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-303)
    <td> DM does not handle NACK properly for LPM msgs and RM board config msg
    <td> DM
</tr>
<tr>
    <td> [ EXT_SITMPUSW-291](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-291)
    <td> Wait for Status mechanism via Sciclient API call fails during self reset
    <td> DM
</tr>
<tr>
    <td> [ EXT_SITMPUSW-312](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-312)
    <td> Incorrect context description of SCICLIENT_CONTEXT_DM2TIFS
    <td> DM
</tr>
<tr>
    <td> [ EXT_SITMPUSW-288](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-288)
    <td> LPM: Unable to enter LPM in Interrupt Mode
    <td> DM
</tr>
<tr>
    <td> [ EXT_SITMPUSW-162](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-162)
    <td> Sciclient, update the context ID check in sciclient ISR
    <td> DM
</tr>
<tr>
    <td> [ EXT_SITMPUSW-161](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-161)
...
<tr>
    <td> [ EXT_SITMPUSW-217](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-217)
    <td> ClockP_usleep() getting into infinite loop due to timer wraparound
    <td> DPL
</tr>
<tr>
    <td> [ EXT_SITMPUSW-196](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-196)
    <td> ClockP_getTimeUsec() returns 1000 us less than the actual time when it's multiple of 1000 us on C7x core.
    <td> DPL
</tr>
<tr>
    <td> [ EXT_SITMPUSW-172](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-172)
    <td> DebugP_assert: change so that it does not lock up the entire core
    <td> DPL
</tr>
<tr>
    <td> [ EXT_SITMPUSW-251](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-251)
    <td> MCU+ SDK Example Projects using incorrect ARMv7 MPU Attributes for Peripheral Register Region
    <td> Examples
</tr>
<tr>
    <td> [ EXT_SITMPUSW-112](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-112)
    <td> SysConfig does not generate correct FLASH section parameters.
    <td> Flash
</tr>
<tr>
    <td> [ EXT_SITMPUSW-297](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-297)
    <td> Flash Params Not Reflected In Syscfg
    <td> FLASH
</tr>
<tr>
    <td> [ EXT_SITMPUSW-301](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-301)
    <td> OSPI_norFlashInit1s1s1s has an implementation of wait for 500 milliseconds instead of microseconds
    <td> Flash
</tr>
<tr>
    <td> [ EXT_SITMPUSW-282](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-282)
    <td> Sysconfig not generating code for GPIO Trigger
    <td> GPIO
</tr>
<tr>
    <td> [ EXT_SITMPUSW-194](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-194)
    <td> NACK is not returned to application when performing i2c write in polling mode
    <td> I2C
</tr>
<tr>
    <td> [ EXT_SITMPUSW-192](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-192)
    <td> SysConfig does not support configuring both 10-bit own addresses for I2C target mode
    <td> I2C
</tr>
<tr>
    <td> [ EXT_SITMPUSW-232](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-232)
    <td> I2C target mode with multiple own addresses transaction fails
    <td> I2C
</tr>
<tr>
    <td> [ EXT_SITMPUSW-183](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-183)
    <td> I2c_transfer not returning correct status when transfer mode is set to polling
    <td> I2C
</tr>
<tr>
    <td> [ EXT_SITMPUSW-179](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-179)
    <td> I2C Target Overrun Test Hangs Waiting for Callback
    <td> I2C
</tr>
<tr>
    <td> [ EXT_SITMPUSW-279](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-279)
    <td> I2C close is not working properly during error conditions
    <td> I2C
</tr>
<tr>
    <td> [ EXT_SITMPUSW-191](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-191)
...
<tr>
    <td> [ EXT_SITMPUSW-207](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-207)
    <td> Missing -p flag with strip command to reduce the size of *.out
    <td> Makefiles
</tr>
<tr>
    <td> [ EXT_SITMPUSW-211](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-211)
    <td> DMA channel teardown sequence is not proper in MCASP_disableDmaTx
    <td> MCASP
</tr>
<tr>
    <td> [ EXT_SITMPUSW-200](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-200)
    <td> [MCSPI] Timeout mechanism missing to prevent Infinite loops in MCSPI driver
    <td> MCSPI
</tr>
<tr>
    <td> [ EXT_SITMPUSW-188](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-188)
    <td> [MCSPI]End of Channel Transfer status check is missing for DMA mode
    <td> MCSPI
</tr>
<tr>
    <td> [ EXT_SITMPUSW-208](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-208)
...
<tr>
    <td> [ EXT_SITMPUSW-171](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-171)
    <td> MMCSD : Read fails when injecting Command time out  fault
    <td> MMCSD
</tr>
<tr>
    <td> [ EXT_SITMPUSW-176](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-176)
    <td> MMCSD : Read fails when injecting Command Index  fault
    <td> MMCSD
</tr>
<tr>
    <td> [ EXT_SITMPUSW-215](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-215)
    <td> MMCSD : Read fails when injecting Command End Bit  fault
    <td> MMCSD
</tr>
<tr>
    <td> [ EXT_SITMPUSW-186](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-186)
    <td> MMCSD : Read fails when injecting Command CRC fault
    <td> MMCSD
</tr>
<tr>
    <td> [ EXT_SITMPUSW-195](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-195)
    <td> MMCSD : Read fails when passing invalid argument.
    <td> MMCSD
</tr>
<tr>
    <td> [ EXT_SITMPUSW-212](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-212)
    <td> MMCSD : Write fails when passing invalid argument.
    <td> MMCSD
</tr>
<tr>
    <td> [ EXT_SITMPUSW-185](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-185)
    <td> MMCSD : Read times out in HS200 mode after writing in SDR50 mode
    <td> MMCSD
</tr>
<tr>
    <td> [ EXT_SITMPUSW-198](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-198)
    <td> MMCSD : EMMC clock validation fails in C7 core
    <td> MMCSD
</tr>
<tr>
    <td> [ EXT_SITMPUSW-230](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-230)
    <td> MMCSD close fails after opening the same instance twice.
    <td> MMCSD
</tr>
<tr>
    <td> [ EXT_SITMPUSW-209](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-209)
    <td> Simultaneous FAT transfer fails for the same instance while being accessed from two different tasks.
    <td> MMCSD
</tr>
<tr>
    <td> [ EXT_SITMPUSW-153](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-153)
    <td> eMMC Init Code ignores early failures and continues Execution
    <td> MMCSD
</tr>
<tr>
    <td> [ EXT_SITMPUSW-155](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-155)
...
<tr>
    <td> [ EXT_SITMPUSW-204](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-204)
...
<tr>
    <td> [ EXT_SITMPUSW-127](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-127)
...
<tr>
    <td> [ EXT_SITMPUSW-213](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-213)
    <td> OSPI Phy Status Check Missing
    <td> OSPI
</tr>
<tr>
    <td> [ EXT_SITMPUSW-190](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-190)
    <td> OSPI_PhyTuneGrapher missing read delay value 4
    <td> OSPI
</tr>
<tr>
    <td> [ EXT_SITMPUSW-187](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-187)
    <td> OSPI DAC Mode Configuration hardcoded and not based on flashsize
    <td> OSPI
</tr>
<tr>
    <td> [ EXT_SITMPUSW-158](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-158)
    <td> OSPI_flashExecCmd has a couple of checks where the code may get stuck
    <td> OSPI
</tr>
<tr>
    <td> [ EXT_SITMPUSW-231](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-231)
    <td> OSPI NAND Writes DAC enable
    <td> OSPI
</tr>
<tr>
    <td> [ EXT_SITMPUSW-295](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-295)
    <td> Flash Close Logic Requires OSPI Handle to be reset to 1S-1S-1S
    <td> OSPI
</tr>
<tr>
    <td> [ EXT_SITMPUSW-280](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-280)
    <td> OSPI Indac Mode Should Check for odd bytes
    <td> OSPI
</tr>
<tr>
    <td> [ EXT_SITMPUSW-256](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-256)
    <td> Incorrect calculation of rowColEnd in the ext_otp_writeMmr
    <td> OTP
</tr>
<tr>
    <td> [ EXT_SITMPUSW-107](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-107)
    <td> AM62A : Reset Isolation sequence is wrong
    <td> RESET
</tr>
<tr>
    <td> [ EXT_SITMPUSW-202](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-202)
    <td> gAppimage is not allocated to the intended section defined in the linker command files
    <td> SBL
</tr>
<tr>
    <td> [ EXT_SITMPUSW-193](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-193)
    <td> DMA is not enabled for SOC Memory boot media in the SysConfig
    <td> SBL
</tr>
<tr>
    <td> [ EXT_SITMPUSW-189](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-189)
...
<tr>
    <td> [ EXT_SITMPUSW-122](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-122)
    <td> HSM core does not boot
    <td> SBL
</tr>
<tr>
    <td> [ EXT_SITMPUSW-205](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-205)
    <td> "sbl_uart_uniflash_stage2" is not prebuilt
    <td> SBL
</tr>
<tr>
    <td> [ EXT_SITMPUSW-292](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-292)
    <td> Bootloader_socOpenFirewalls is called before System_init in the SBLs
    <td> SBL
</tr>
<tr>
    <td> [ EXT_SITMPUSW-226](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-226)
    <td> Improve Sysconfig tool tips for all drivers
    <td> SysConfig
</tr>
<tr>
    <td> [ EXT_SITMPUSW-281](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-281)
    <td> UART: UART_open fails when NULL argument is passed as UART_Params argument
    <td> UART
</tr>
<tr>
    <td> [ EXT_SITMPUSW-174](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-174)
    <td> UDMA: HC/UHC channel allocation fails due to RM config mismatch with CSL defines
    <td> UDMA
</tr>
<tr>
    <td> [ EXT_SITMPUSW-214](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-214)
    <td> UDMA multiple channel open for the same channel and invalid instance not handling properly
    <td> UDMA
</tr>
<tr>
    <td> [ EXT_EP-13057](https://sir.ext.ti.com/jira/browse/EXT_EP-13057)
    <td> SDL DCC Seed Value Calculation Deviates from TRM Guidelines
    <td> SDL-DCC
</tr>
<tr>
    <td> [ EXT_EP-13058](https://sir.ext.ti.com/jira/browse/EXT_EP-13058)
    <td> PBIST Example/FT/UT fail in UART Bootmode
    <td> SDL-PBIST
</tr>
<tr>
    <td> [ EXT_EP-13056](https://sir.ext.ti.com/jira/browse/EXT_EP-13056)
...
<tr>
    <td> [ EXT_EP-13267](https://sir.ext.ti.com/jira/browse/EXT_EP-13267)
...
<tr>
    <td> [ EXT_SITMPUSW-219](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-219)
...
<tr>
    <td> [ EXT_SITMPUSW-224](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-224)
    <td> Mcasp :  Not working on interrupt mode
    <td> MCASP
</tr>
<tr>
    <td> [ EXT_SITMPUSW-246](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-246)
    <td> AM62A : MCSPI DMA channels Teardown Failures When DMA transaction is Incomplete
    <td> MCSPI
</tr>
<tr>
    <td> [ EXT_SITMPUSW-222](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-222)
    <td> MMCSD field Card Type is not ordered logically in the Sysconfig
    <td> MMCSD
</tr>
<tr>
    <td> [ EXT_SITMPUSW-220](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-220)
    <td> SBL_SD bootloaders report incorrect boot image size
    <td> SBL
</tr>
<tr>
    <td> [ EXT_SITMPUSW-329](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-329)
    <td> Incorrect Value of UART_EFR2_TIMEOUT_BEHAVE_MASK
    <td> UART
</tr>
<tr>
    <td> [ EXT_SITMPUSW-324](https://sir.ext.ti.com/jira/browse/EXT_SITMPUSW-324)
...
<tr>
    <td> [ EXT_EP-13265](https://sir.ext.ti.com/jira/browse/EXT_EP-13265)
...
-------------|----------------------------------------|----------------| -----------------
Bootloader   |  [BOOTLOADER](../../components/drivers/bootloader.md)  &zwj; |   <= 10.01.00  | >= 11.00.00
OSPI         |  [OSPI Migration Guide](../../migration_guides/ospi_migration_guide.md)     &zwj;         |   <= 11.01.00  | >= 11.02.00
Watchdog     |  [WATCHDOG](../../components/drivers/watchdog.md)  &zwj;         |   <= 11.01.00  | >= 11.02.00
SCI Server   |  [DEVICE MANAGER](../../components/drivers/device_manager.md)  &zwj;        |   <= 11.01.00  | >= 11.02.00
