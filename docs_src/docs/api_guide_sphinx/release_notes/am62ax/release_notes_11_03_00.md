...
For SOC device driver support information per CPU, refer to [Buildsheet](../../buildsheet/buildsheet_am62dx.md).
...
SBL Linker   |  [BOOTLOADER](../../components/drivers/bootloader.md)  &zwj;      |   <= 11.02.00  | >= 11.03.00
