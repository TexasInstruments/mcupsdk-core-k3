...
:::{note}
Refer {ref}`Accessing main and wakeup domain peripherals from MCU domain <MAIN_DOMAIN_PERIPHERAL_FROM_MCU>` for accessing main/wakeup peripherals from M4F. ### Board Device Drivers
:::
