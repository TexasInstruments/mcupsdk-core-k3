...
const files = {
    common: [
        "hyperRam_xip_benchmark.c",
        "hyperRam_xip_fir.c",
        "hyperRam_xip_memcpy.c",
        "main.c",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_BENCHMARKS_XIP_BENCHMARK";
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "hyperRam_xip_benchmark_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "hyperRam_xip_benchmark";
    property.isInternal = false;
    property.tirexResourceSubClass = [ "example.gettingstarted" ];
    property.description = "A \"xip benchmark\" example. This example shows configuration and usage of CPU and baremetal/RTOS kernel for MPU, cache, interrupts, heaps, semaphores, timers and cycle counters."
