...
SECTIONS
{
    ...
    .text            : {} palign(8)      > HYPERRAM
    .const           : {} palign(8)      > HYPERRAM
    .rodata          : {} palign(8)      > HYPERRAM
    .cinit           : {} palign(8)      > HYPERRAM
    .far             : {} align(4)       > HYPERRAM
    .data            : {} palign(128)    > HYPERRAM
    .sysmem          : {}                > HYPERRAM
    .data_buffer     : {} palign(128)    > HYPERRAM
    .boardcfg_data   : {} align(4)       > HYPERRAM
