...
const includes_freertos_r5f = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/examples/board/hyperRam/hyperRam_ecc_test/dpl",
    ],
};
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "hyperRam_ecc_esm_test_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "hyperRam_ecc_esm_test";
    property.isInternal = false;
    property.description = "A Hyper Ram ECC functionality test example."
