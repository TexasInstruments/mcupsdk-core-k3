...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_AASRC_MULTICHANNEL_PLAYBACK";
...
function getComponentProperty() {
    ...
    property.name = "aasrc_multichannel_playback";
    property.isInternal = false;
    property.tirexResourceSubClass = [ "example.gettingstarted" ];
    property.description = "This example verifies AASRC multichannel playback"
