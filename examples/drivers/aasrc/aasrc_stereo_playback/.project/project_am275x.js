...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_AASRC_STEREO_PLAYBACK";
...
function getComponentProperty() {
    ...
    property.name = "aasrc_stereo_playback";
    property.isInternal = false;
    property.tirexResourceSubClass = [ "example.gettingstarted" ];
    property.description = "This example verifies AASRC stereo playback"
