...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_ADC_SINGLESHOT";
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "adc_singleshot_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "adc_singleshot";
    property.isInternal = false;
    property.description = "An ADC singleshot example. This example demonstrates interrupts in ADC."
