...
SECTIONS
{
    ...
    GROUP (NOLOAD){
        ...
        RUN_END(__BSS_END)
    } > WKUP_R5_MSRAM_NOLOAD

    /* USB or any other LLD buffer for benchmarking */
    .benchmark_buffer {} ALIGN (8) > WKUP_R5_MSRAM
...
MEMORY
{
    ...
    WKUP_R5_MSRAM (RWIX)         : ORIGIN = 0x72000000+0x40 LENGTH = 0x00100000-0x40 // 512 KB for wakeup core
    WKUP_R5_MSRAM_NOLOAD (RWIX)  : ORIGIN = 0x72500000      LENGTH = 0x00080000

    // 1.5 MB for .bss, FileBuf and scratch buf
    APP_OCRAM     (RWIX)         : ORIGIN = 0x72200000 LENGTH = 0x00180000
    SCRATCH       (RWIX)         : ORIGIN = 0x72380000 LENGTH = 0x00180000
}
