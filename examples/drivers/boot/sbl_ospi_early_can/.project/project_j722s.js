...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_SBL_OSPI_EARLY_CAN";
...
function getComponentProperty() {
    ...
    property.name = "sbl_ospi_early_can";
    property.isInternal = false;
    property.isBootLoader = true;
    property.description = "Customised OSPI SBL example with optimizations for Early CAN Response.",
