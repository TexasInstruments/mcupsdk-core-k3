...
const robot_template_ddr_ecc = {
    ...
    options: {
        componentName: "SBL",
        testCaseName: "Bootloader: SBL OSPI NOR Linux with DDR ECC enabled",
        appName: "sbl_ospi_linux_multistage(ddr_ecc)",
        testCaseIds: "SITSW-3563",
        cfgPath: "test/drivers/boot/sbl_ospi_linux_multistage_ddr_ecc/{board}/default_sbl_ospi_linux_${DEVICE_TYPE}.cfg",
        bootMode: "OSPI_NOR_BOOT_MODE",
        expectTimeout: 300,
        timeout: 900,
        useNFS: true,
