...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_CSIRX_IMX219_TEST";
...
function getComponentProperty() {
    ...
    property.name = "csirx_imx219_testapp";
    property.isInternal = false;
    property.tirexResourceSubClass = [ "example.gettingstarted" ];
    property.description = "Capture testapp "
