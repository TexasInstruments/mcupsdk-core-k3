...
const files = {
    common: [
        "eqep_frequency_measurement_v1.c",
        "main.c",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_EQEP_FREQUENCY_MEASUREMENT";
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "eqep_frequency_measurement_main",
        },
    },
];
...
function getComponentProperty(device) {
    ...
    property.name = "eqep_frequency_measurement";
    property.isInternal = false;
    property.description = "An EQEP Frequency Measurement example. This example measures frequency of signal generated by EPWM module."
