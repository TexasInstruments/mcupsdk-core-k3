...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_I2C_MEMORY_READ";
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "i2c_memory_read_main",
        },
    },
];
...
function getComponentProperty() {
    ...
    property.name = "i2c_memory_read";
    property.isInternal = false;
    property.description = "A I2C Memory read example. Write and Read from particular EEPROM memory in the AM62DX-EVM board."
...
const robot_template = {
    ...
    options: {
        componentName: "I2C",
        testCaseName: "I2C EEPROM Write and Readback sample application",
        testCaseIds: "SITSW-4831",
    },
};
