...
SECTIONS
{
     ...
     */
    .shared.data    : {} > C3_SSO_LCL , palign(4096)
    .shared.bss     : {} > C3_SSO_LCL , palign(4096)
}
...
MEMORY
{
    ...
    SSO_SHM_RX   : ORIGIN = 0x724A0000 , LENGTH = 0x4000  /* .shared.text  */
    SSO_SHM_RO   : ORIGIN = 0x724A4000 , LENGTH = 0x4000  /* .shared.rodata */
    SSO_SHM_RW   : ORIGIN = 0x724A8000 , LENGTH = 0x8000  /* .shared.bss + .shared.data */
