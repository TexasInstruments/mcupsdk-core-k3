...
SECTIONS
{
    ...
    .bss.filebuf(NOLOAD) : {} > IPC_FILEBUF
    .bss.dspmsg(NOLOAD) : {} > IPC_FILEBUF
    .bss.dspparams(NOLOAD) : {} > IPC_FILEBUF
...
MEMORY
{
    ...
    R50_0_OCRAM   (RWIX)         : ORIGIN = 0x72080000 LENGTH   = 0x000C0000   // 768 kB for r5fss0-0 core
    R50_0_OCRAM2  (RWIX)         : ORIGIN = 0x72480000 , LENGTH = 0x00180000   //1.5 MB for r5fss0-0 core
    IPC_FILEBUF   (RWIX)         : ORIGIN = 0x72140000 LENGTH   = 0x00040000   // 256 kB for IPC Buffer
