...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_MCAN_EXTERNAL_READ_WRITE";
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "mcan_external_read_write_main",
        },
    }
];
...
function getComponentProperty() {
    ...
    property.name = "mcan_external_read_write";
...
const robot_template = {
    ...
    options: {
        componentName: "MCAN",
        testCaseName: "mcan_external_read_write application",
        testCaseIds: "SITSW-4860",
    },
};
