...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_MCAN_RESPONSE_APP";
...
function getComponentProperty() {
    ...
    property.name = "mcan_response_app";
    property.isInternal = false;
    property.buildOptionCombos = buildOptionCombos;
    property.description = "Application to measure CAN response time."
