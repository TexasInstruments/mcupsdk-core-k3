...
SECTIONS
{
    ...
    .text            : {} palign(8)      > MS_RAM
    .const           : {} palign(8)      > MS_RAM
    .rodata          : {} palign(8)      > MS_RAM
    .cinit           : {} palign(8)      > MS_RAM
    .far             : {} align(4)       > MS_RAM
    .data            : {} palign(128)    > MS_RAM
    .sysmem          : {}                > MS_RAM
    .data_buffer     : {} palign(128)    > MS_RAM
    .boardcfg_data   : {} align(4)       > MS_RAM
    ...
    .benchmark_buffer (NOLOAD) {} ALIGN (8) > MS_RAM

    .stack      : {} align(4) > MS_RAM  (HIGH)
...
MEMORY
{
    ...
    /* MS_RAM for code/data as DDR is not initialised */
    MS_RAM   : ORIGIN = 0x79100000 , LENGTH = 0x80000
