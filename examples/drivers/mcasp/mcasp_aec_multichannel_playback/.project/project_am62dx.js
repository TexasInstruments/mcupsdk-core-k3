...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_MCASP_MULTICHANNEL_AEC";
...
function getComponentProperty() {
    ...
    property.name = "mcasp_aec_playback";
    property.isInternal = false;
    property.tirexResourceSubClass = [ "example.gettingstarted" ];
    property.description = "This example verifies MCASP Audio Expansion Card Multichannel Playback"
...
const robot_template = {
    ...
    options: {
        componentName: "MCASP",
        testCaseName: "mcasp_aec_multichannel_playback application",
        testCaseIds: "SITSW-6175",
    },
};
