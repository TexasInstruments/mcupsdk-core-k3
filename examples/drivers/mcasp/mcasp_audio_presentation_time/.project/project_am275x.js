...
const files = {
	common: [
		"mcasp_audio_presentation_time.c",
		"main.c",
	],
};
...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_MCASP_AUDIO_PRESENTATION_TIME";
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "mcasp_audio_presentation_time_main",
        },
    }
];
...
const robot_template = {
    ...
    options: {
        componentName: "MCASP",
        testCaseName: "mcasp audio presentation time",
        testCaseIds: "SITSW-12290",
    },
};
...
function getComponentProperty() {
    ...
    property.name = "mcasp_audio_presentation_time";
    property.isInternal = false;
    property.tirexResourceSubClass = [ "example.gettingstarted" ];
    property.description = "MCASP Audio Presentation Time Example - Demonstrates queue status and presentation time APIs for RNC applications"
