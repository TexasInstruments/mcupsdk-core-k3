...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_MCASP_MULTICHANNEL_IN_STEREO_OUT";
...
function getComponentProperty() {
    ...
    property.name = "mcasp_multichannel_in_stereo_out";
    property.isInternal = false;
    property.tirexResourceSubClass = [ "example.gettingstarted" ];
    property.description = "This example verifies MCASP multichannel in stereo out"
...
const robot_template = {
    ...
    options: {
        componentName: "MCASP",
        testCaseName: "mcasp_multichannel_in_stereo_out application",
        testCaseIds: "SITSW-4839",
    },
};
