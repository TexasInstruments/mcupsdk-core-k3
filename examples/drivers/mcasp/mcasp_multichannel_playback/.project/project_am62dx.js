...
function getComponentProperty() {
    ...
    property.name = "mcasp_multichannel_playback";
    property.isInternal = false;
    property.tirexResourceSubClass = [ "example.gettingstarted" ];
    property.description = "This example verifies MCASP multichannel playback"
...
const robot_template = {
    ...
    options: {
        componentName: "MCASP",
        testCaseName: "mcasp_multichannel_playback application",
        testCaseIds: "SITSW-4838",
    },
};
