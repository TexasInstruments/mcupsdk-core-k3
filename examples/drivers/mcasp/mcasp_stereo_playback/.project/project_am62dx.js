...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_MCASP_STEREO_PLAYBACK";
...
function getComponentProperty() {
    ...
    property.name = "mcasp_stereo_playback";
...
const robot_template = {
    ...
    options: {
        componentName: "MCASP",
        testCaseName: "mcasp_stereo_playback application",
        testCaseIds: "SITSW-4840",
    },
};
