...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_MCSPI_PERFORMANCE_8BIT";
...
function getComponentProperty() {
    ...
    property.name = "mcspi_performance_8bit";
...
const robot_template = {
    ...
    options: {
        componentName: "MCSPI",
        testCaseName: "McSPI Low Latency Sample Application 8bit",
        testCaseIds: "SITSW-1437",
        expectTimeout: 120,
    },
};
