...
const robot_template = {
    ...
    options: {
        componentName: "PMIC",
        testCaseName: "PMIC: Q&A watchdog interrupt mode example",
        testCaseIds: "SITSW-4632",
    },
};
...
function getComponentProperty() {
    ...
    property.description = "An example to show PMIC watchdog operation in Q&A mode which generates an interrupt when MCU fails to send watchdog signal. "
