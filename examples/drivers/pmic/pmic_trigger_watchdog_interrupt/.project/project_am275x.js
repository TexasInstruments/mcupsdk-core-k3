...
const files = {
    common: [
        "main.c",
        "board.c",
        "pmic_trigger_watchdog_interrupt.c",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_PMIC_TRIGGER_WATCHDOG_INTERRUPT";
...
[
	...
	},
	{
		...
		output: "../main.c",
		options: {
		entryFunction: "pmic_trigger_watchdog_interrupt_main",
		},
	}
];
...
const robot_template = {
    ...
    options: {
        componentName: "PMIC",
        testCaseName: "PMIC: Trigger watchdog interrupt mode example",
        testCaseIds: "SITSW-4635",
    },
};
...
function getComponentProperty() {
    ...
    property.name = "pmic_trigger_watchdog_interrupt";
    property.isInternal = false;
    property.description = "An example to show PMIC watchdog operation in trigger mode which generates an interrupt when MCU fails to send watchdog signal. "
