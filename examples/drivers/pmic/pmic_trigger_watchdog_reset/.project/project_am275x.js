...
const readmeDoxygenPageTag = "EXAMPLES_PMIC_TRIGGER_WATCHDOG_RESET";
...
[
	...
	},
	{
		...
		output: "../main.c",
		options: {
		entryFunction: "pmic_trigger_watchdog_reset_main",
		},
	}
];
...
const robot_template = {
    ...
    options: {
        ...
        cfgPath: "examples/drivers/pmic/pmic_trigger_watchdog_reset/am275x-evm/default_pmic_trigger_watchdog_reset_${DEVICE_TYPE}.cfg",
...
function getComponentProperty() {
    ...
    property.name = "pmic_trigger_watchdog_reset";
    property.isInternal = false;
    property.description = "An example to show PMIC watchdog operation in trigger mode which generates a reset when MCU fails to send watchdog signal. "
