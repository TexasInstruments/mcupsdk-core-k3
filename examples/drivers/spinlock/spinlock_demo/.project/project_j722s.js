...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "SpinlockApp_main",
        },
    }
];
...
function getComponentProperty(device) {
    ...
    property.name = "spinlock_demo";
    property.isInternal = false;
    property.description = "Spinlock app to demonstrate functionality by acquiring and releasing different locks."
