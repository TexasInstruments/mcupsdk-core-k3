...
const readmeDoxygenPageTag = "EXAMPLES_KERNEL_DATA_ABORT";
...
const robot_template = {
    ...
    options: {
        componentName: "DPL",
        testCaseName: "DPL: Data abort handler test",
        testCaseIds: "SITSW-7112",
    },
};
...
function getComponentProperty() {
    ...
    property.name = "test_data_abort";
    property.isInternal = false;
    property.description = "A simple example to test data abort."
