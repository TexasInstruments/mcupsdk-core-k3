...
const readmeDoxygenPageTag = "EXAMPLES_KERNEL_UNDEFINED_ABORT";
...
const robot_template = {
    ...
    options: {
        componentName: "DPL",
        testCaseName: "DPL: Undefined abort handler test",
        testCaseIds: "SITSW-7115",
    },
};
...
function getComponentProperty() {
    ...
    property.name = "test_undef";
    property.isInternal = false;
    property.description = "A simple example to test undefined abort."
