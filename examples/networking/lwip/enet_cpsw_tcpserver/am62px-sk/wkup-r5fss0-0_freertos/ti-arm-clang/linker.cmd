...
SECTIONS
{
    ...
    .fs_stub (NOLOAD): {} align(8)       > DDR_FS_STUB
    .text            : {} palign(8)      > DDR
    .const           : {} palign(8)      > DDR
    .rodata          : {} palign(8)      > DDR
    .cinit           : {} palign(8)      > DDR
    ...
    .const.devgroup  : { *(.const.devgroup*) } align(8) > DDR
    .boardcfg_data   : {} align(8)       > DDR

    GROUP {
        .bss.devgroup : { *(.bss.devgroup*) } align(8)
        RUN_START(__BSS_START)
        .bss:    {} palign(128)   /* This is where uninitialized globals go */
        RUN_END(__BSS_END)
