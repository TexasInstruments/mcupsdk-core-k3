...
const includes_nortos = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/examples/sdl/vtm/vtm_reset/",
    ],
};
...
function getComponentProperty() {
    ...
    property.name = "vtm_reset_example";
    property.isInternal = false;
    property.description = "This example verifies VTM triggered SoC reset operation"
