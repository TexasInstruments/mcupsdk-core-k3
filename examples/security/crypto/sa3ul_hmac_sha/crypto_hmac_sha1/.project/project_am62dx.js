...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_SA3UL_HMAC_SHA1";
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "crypto_hmac_sha1",
        },
    },
...
function getComponentProperty() {
    ...
    property.name = "crypto_hmac_sha1";
    property.isInternal = false;
    property.buildOptionCombos = buildOptionCombos;
    property.description = "A Crypto HMAC SHA1 example.";
...
const robot_template = {
    ...
    output: "../tests.robot",
    options: {
        componentName: "HMAC,SHA",
        testCaseName: "SA3UL Crypto HMAC - SHA1 example",
        testCaseIds: "SITSW-3114",
    },
};
