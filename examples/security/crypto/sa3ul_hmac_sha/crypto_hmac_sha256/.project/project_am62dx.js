...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_SA3UL_HMAC_SHA256";
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "crypto_hmac_sha256",
        },
    },
...
function getComponentProperty() {
    ...
    property.name = "crypto_hmac_sha256";
    property.isInternal = false;
    property.buildOptionCombos = buildOptionCombos;
    property.description = "A Crypto HMAC SHA256 example.";
...
const robot_template = {
    ...
    output: "../tests.robot",
    options: {
        componentName: "HMAC,SHA2",
        testCaseName: "SA3UL Crypto HMAC - SHA256 example",
        testCaseIds: "SITSW-3115",
    },
};
