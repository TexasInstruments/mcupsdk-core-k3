...
const files = {
    common: [
        "crypto_hmac_sha256_multishot.c",
        "main.c",
    ],
};
...
const libs_freertos_a53 = {
    common: [
        ...
        "security.am62dx.a53.gcc-aarch64.${ConfigName}.lib",
    ],
};
...
const readmeDoxygenPageTag = "EXAMPLES_DRIVERS_SA3UL_HMAC_SHA256_MULTISHOT";
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "crypto_hmac_sha256_multishot",
        },
    },
...
function getComponentProperty() {
    ...
    property.name = "crypto_hmac_sha256_multishot";
    property.isInternal = false;
    property.buildOptionCombos = buildOptionCombos;
    property.description ="A Crypto HMAC SHA256 Multishot example.";
...
const robot_template = {
    ...
    options: {
        ...
        testCaseName: "SA3UL Crypto HMAC - SHA256 Multi shot example",
        testCaseIds: "SITSW-3116",
    },
};
