...
const files_c7x = {
    ...
    cpp_common: [
    	"TISP_8ch_to_12ch_audio_chain.cpp",
...
const readmeDoxygenPageTag = "EXAMPLES_TISP_SIGCHAIN_8CH_TO_12CH_AUDIO_CHAIN";
...
const systemProjects =[
    {
        name: "sigchain_8ch_to_12ch_audio_chain",
        tag: "freertos_nortos",
...
function getComponentProperty() {
    ...
    property.name = "sigchain_8ch_to_12ch_audio_chain";
...
const robot_template = {
    ...
    options: {
        componentName: "TISP",
        testCaseName: "sigchain_8ch_to_12ch_audio_chain application",
        testCaseIds: "SITSW-9117",
    },
};
