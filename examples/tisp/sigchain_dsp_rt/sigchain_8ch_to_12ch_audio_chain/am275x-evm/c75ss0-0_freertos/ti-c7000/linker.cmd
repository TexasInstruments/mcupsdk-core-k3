...
MEMORY
{
    ...
    C75_0_OCRAM   (RWIX)         : ORIGIN = 0x80200040 LENGTH = 0x000C0000 - 0x40 - 0x1000
    C75_0_CIO_MEM                 : ORIGIN = 0x80200040 + 0x000C0000 - 0x40 - 0x1000 LENGTH = 0x1000  /* 768 KB for c75ss0-0 core */
    ...
    /* R51_0_OCRAM   (RWIX)         : ORIGIN = 0x80280000 LENGTH = 0x00100000 */    /* 512 KB for r5fss1-0 core */
...
SECTIONS
{
    ...
    .l2sramData > C75_0_L2SRAM
    .staticData > C75_0_L2SRAM
    sigchain_mcasp_buffer (NOLOAD) > C75_0_L2SRAM
