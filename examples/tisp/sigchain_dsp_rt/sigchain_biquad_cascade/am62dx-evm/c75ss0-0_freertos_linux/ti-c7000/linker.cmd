...
MEMORY
{
    L2SRAM (RWX):  org = 0x7E000000,          len = 0x00200000
...
SECTIONS
{
    ...
    .stack      >       C7X_DDR_SPACE ALIGN(0x20000)
    .args       >       C7X_DDR_SPACE
    .cio        >       C7X_CIO_MEM
    .const      >       C7X_DDR_SPACE
    ...
    .audioDataDDR > C7X_DDR_SPACE ALIGN(128)    /* Audio data buffer (2dfft-style) */
    .l2sramData > L2SRAM
    .staticData > L2SRAM
    sigchain_mcasp_buffer (NOLOAD) > L2SRAM
    ...
    .tisp_node_arena    > L2SRAM ALIGN(128)
    .tisp_twiddle_arena > L2SRAM ALIGN(64)
    .tisp_handle_arena  > L2SRAM ALIGN(32)
}
