        ...
        },
        {
            ...
            onChange: function(inst, ui) {
                ...
                if(inst.flashType == "SERIAL_NOR") {
                    ...
                    inst.cmdRd = serialNandDefaultCfg.protos[defProtoJson].cmdRd,
                    inst.cmdWr = serialNandDefaultCfg.protos[defProtoJson].cmdWr,
                    inst.dummyClksCmd = serialNandDefaultCfg.protos[defProtoJson].dummyClksCmd;
                    inst.dummyClksRd = serialNandDefaultCfg.protos[defProtoJson].dummyClksRd;

                    inst.dummy_isAddrReg = serialNandDefaultCfg.protos[defProtoJson].dummyCfg == null ? false : serialNandDefaultCfg.protos[defProtoJson].dummyCfg.isAddrReg;
                    inst.dummy_cfgReg = serialNandDefaultCfg.protos[defProtoJson].dummyCfg == null ? "0x00" : serialNandDefaultCfg.protos[defProtoJson].dummyCfg.cfgReg;
                    inst.dummy_cmdRegRd = serialNandDefaultCfg.protos[defProtoJson].dummyCfg == null ? "0x00" : serialNandDefaultCfg.protos[defProtoJson].dummyCfg.cmdRegRd;
                    inst.dummy_cmdRegWr = serialNandDefaultCfg.protos[defProtoJson].dummyCfg == null ? "0x00" : serialNandDefaultCfg.protos[defProtoJson].dummyCfg.cmdRegWr;

                    inst.dummy_shift = serialNandDefaultCfg.protos[defProtoJson].dummyCfg == null ? 0 : serialNandDefaultCfg.protos[defProtoJson].dummyCfg.shift;
                    inst.dummy_mask = serialNandDefaultCfg.protos[defProtoJson].dummyCfg == null ? "0x00" : serialNandDefaultCfg.protos[defProtoJson].dummyCfg.mask;
                    inst.dummy_bitP = serialNandDefaultCfg.protos[defProtoJson].dummyCfg == null ? 0 : serialNandDefaultCfg.protos[defProtoJson].dummyCfg.bitP;

                    inst.proto_isAddrReg = serialNandDefaultCfg.protos[defProtoJson].protoCfg == null ? false : serialNandDefaultCfg.protos[defProtoJson].protoCfg.isAddrReg;
                    inst.proto_cfgReg = serialNandDefaultCfg.protos[defProtoJson].protoCfg == null ? "0x00" : serialNandDefaultCfg.protos[defProtoJson].protoCfg.cfgReg;
                    inst.proto_cmdRegRd = serialNandDefaultCfg.protos[defProtoJson].protoCfg == null ? "0x00" : serialNandDefaultCfg.protos[defProtoJson].protoCfg.cmdRegRd;
                    inst.proto_cmdRegWr = serialNandDefaultCfg.protos[defProtoJson].protoCfg == null ? "0x00" : serialNandDefaultCfg.protos[defProtoJson].protoCfg.cmdRegWr;

                    inst.proto_shift = serialNandDefaultCfg.protos[defProtoJson].protoCfg == null ? 0 : serialNandDefaultCfg.protos[defProtoJson].protoCfg.shift;
                    inst.proto_mask = serialNandDefaultCfg.protos[defProtoJson].protoCfg == null ? "0x00" : serialNandDefaultCfg.protos[defProtoJson].protoCfg.mask;
                    inst.proto_bitP = serialNandDefaultCfg.protos[defProtoJson].protoCfg == null ? 0 : serialNandDefaultCfg.protos[defProtoJson].protoCfg.bitP;
            ...
            getDisabledOptions: (inst) => {
                if(inst.flashType == "SERIAL_NOR")
                {
                    ...
                    let disabledOptions = [
                            ...
                            { name : "1s_1s_4s", displayName : "1S-1S-4S", reason:"Not supported for NAND Flash" },
