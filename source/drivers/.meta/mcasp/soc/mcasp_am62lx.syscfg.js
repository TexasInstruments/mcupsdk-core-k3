...
const mcasp_config = [
    {
        ...
        a53RxIntr                   : 277,
        a53TxIntr                   : 278,
        clockIds                    : ["AM62LX_DEV_MCASP0"],
        clockFrequencies            : [
            {
                moduleId: "AM62LX_DEV_MCASP0",
                clkId   : "AM62LX_DEV_MCASP0_AUX_CLK",
    ...
    },
    {
        ...
        a53RxIntr                   : 279,
        a53TxIntr                   : 280,
        clockIds                    : ["AM62LX_DEV_MCASP1"],
        clockFrequencies            : [
            {
                moduleId: "AM62LX_DEV_MCASP1",
                clkId   : "AM62LX_DEV_MCASP1_AUX_CLK",
                clkRate : mcasp_input_clk_freq,
            }
        ],
        udmaPdmaChannels            : [
    ...
    },
    {
        ...
        a53RxIntr                   : 281,
        a53TxIntr                   : 282,
        clockIds                    : ["AM62LX_DEV_MCASP2"],
        clockFrequencies            : [
            {
                moduleId: "AM62LX_DEV_MCASP2",
                clkId   : "AM62LX_DEV_MCASP2_AUX_CLK",
                clkRate : mcasp_input_clk_freq,
            }
        ],
        udmaPdmaChannels            : [
