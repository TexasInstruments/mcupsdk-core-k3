...
const uart_config_c75 = [
    {
        ...
        inputClkFreq    : uart_input_clk_freq,
        intrNum         : 22,
        eventId         : 186+256, /* (256 - GIC SPI Intr start, ref: clec_spec am62d_soc_event_out_mapping)*/
        clockIds        : [ "TISCI_DEV_WKUP_UART0" ],
        clockFrequencies: [
            {
                moduleId: "TISCI_DEV_WKUP_UART0",
    ...
    },
    {
        ...
        inputClkFreq    : uart_input_clk_freq,
        intrNum         : 23,
        eventId         : 185+256, /* (256 - GIC SPI Intr start, ref: clec_spec am62d_soc_event_out_mapping)*/
        clockIds        : [ "TISCI_DEV_MCU_UART0" ],
        clockFrequencies: [
            {
                moduleId: "TISCI_DEV_MCU_UART0",
    ...
    },
    {
        ...
        inputClkFreq    : uart_input_clk_freq,
        intrNum         : 24,
        eventId         : 178+256, /* (256 - GIC SPI Intr start, ref: clec_spec am62d_soc_event_out_mapping)*/
        clockIds        : [ "TISCI_DEV_UART0" ],
        clockFrequencies: [
            {
                moduleId: "TISCI_DEV_UART0",
    ...
    },
    {
        ...
        inputClkFreq    : uart_input_clk_freq,
        intrNum         : 25,
        eventId         : 179+256, /* (256 - GIC SPI Intr start, ref: clec_spec am62d_soc_event_out_mapping)*/
        clockIds        : [ "TISCI_DEV_UART1" ],
        clockFrequencies: [
            {
                moduleId: "TISCI_DEV_UART1",
    ...
    },
    {
        ...
        inputClkFreq    : uart_input_clk_freq,
        intrNum         : 26,
        eventId         : 180+256, /* (256 - GIC SPI Intr start, ref: clec_spec am62d_soc_event_out_mapping)*/
        clockIds        : [ "TISCI_DEV_UART2" ],
        clockFrequencies: [
            {
                moduleId: "TISCI_DEV_UART2",
    ...
    },
    {
        ...
        inputClkFreq    : uart_input_clk_freq,
        intrNum         : 27,
        eventId         : 181+256, /* (256 - GIC SPI Intr start, ref: clec_spec am62d_soc_event_out_mapping)*/
        clockIds        : [ "TISCI_DEV_UART3" ],
        clockFrequencies: [
            {
                moduleId: "TISCI_DEV_UART3",
    ...
    },
    {
        ...
        inputClkFreq    : uart_input_clk_freq,
        intrNum         : 28,
        eventId         : 182+256, /* (256 - GIC SPI Intr start, ref: clec_spec am62d_soc_event_out_mapping)*/
        clockIds        : [ "TISCI_DEV_UART4" ],
        clockFrequencies: [
            {
                moduleId: "TISCI_DEV_UART4",
    ...
    },
    {
        ...
        inputClkFreq    : uart_input_clk_freq,
        intrNum         : 29,
        eventId         : 183+256, /* (256 - GIC SPI Intr start, ref: clec_spec am62d_soc_event_out_mapping)*/
        clockIds        : [ "TISCI_DEV_UART5" ],
        clockFrequencies: [
            {
                moduleId: "TISCI_DEV_UART5",
    ...
    },
    {
        ...
        inputClkFreq    : uart_input_clk_freq,
        intrNum         : 30,
        eventId         : 184+256, /* (256 - GIC SPI Intr start, ref: clec_spec am62d_soc_event_out_mapping)*/
        clockIds        : [ "TISCI_DEV_UART6" ],
        clockFrequencies: [
            {
                moduleId: "TISCI_DEV_UART6",
