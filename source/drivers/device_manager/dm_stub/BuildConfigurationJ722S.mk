...
CONFIG_LPM_BOARDCFG_MANAGED_STUB=y
CONFIG_LPM_DM_TRACE=y
CONFIG_LPM_DM_TRACE_BUFFER=n
CONFIG_LPM_DM_TRACE_UART=n
CONFIG_LPM_32_BIT_DDR=y

ifeq ($(CONFIG_LPM_BOARDCFG_MANAGED_STUB),y)
  CFLAGS_LOCAL_COMMON += -DCONFIG_LPM_BOARDCFG_MANAGED_STUB
endif
...
CONFIG_SOC_FOLDER_STRING=j722s
