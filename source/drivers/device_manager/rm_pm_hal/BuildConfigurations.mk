...
ifeq ($(CONFIG_PM_CLK_SSC),y)
CFLAGS_LOCAL_COMMON += -DCONFIG_PM_CLK_SSC
endif
ifeq ($(CONFIG_GET_DEVICE_MULTIPLE),y)
CFLAGS_LOCAL_COMMON += -DCONFIG_GET_DEVICE_MULTIPLE
endif
...
else ifeq ($(CONFIG_LPM_MIN),y)
CFLAGS_LOCAL_COMMON += -DCONFIG_LPM_MIN
else ifeq ($(CONFIG_LPM_BOARDCFG_MANAGED),y)
CFLAGS_LOCAL_COMMON += -DCONFIG_LPM_BOARDCFG_MANAGED
else ifeq ($(CONFIG_NO_LPM),y)
CFLAGS_LOCAL_COMMON += -DCONFIG_NO_LPM
endif
ifeq ($(CONFIG_TRACE),y)
