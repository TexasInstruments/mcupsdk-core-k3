 ...
 *
 * SoC Data for Secure Proxy Instances for AM62A device
 *
...
const struct Sciserver_SecureProxy gSciserverSecureProxyInstances[SOC_MAX_SEC_PROXY_INSTANCES] = {
	/*
	 * [0] AM62A_SPROXY_IDX_DMASS0_SEC_PROXY_0: Secure proxy instance:
	 * DMASS0_SEC_PROXY_0 linked to RA inst: DMASS0_RINGACC_0
	 */
	[AM62A_SPROXY_IDX_DMASS0_SEC_PROXY_0] =	 {
		...
		.num_threads			= 76U,
		.devgrp				= SOC_DEVGRP_AM62A_TIFS_INTERNAL,
		.ra_idx				= AM62A_RA_IDX_DMASS0_RINGACC_0,
		.buffer_idx			= AM62A_SPROXY_MEM_IDX_DMSS_IPC_SRAM,
		.buffer_neg_offset		= 0x00001300U,
	},
	/*
	 * [1] AM62A_SPROXY_IDX_SA3_SS0_SEC_PROXY_0: Secure proxy instance:
	 * SA3_SS0_SEC_PROXY_0 linked to RA inst: SA3_SS0_RINGACC_0
	 */
	[AM62A_SPROXY_IDX_SA3_SS0_SEC_PROXY_0] = {
		...
		.num_threads			= 16U,
		.devgrp				= SOC_DEVGRP_AM62A_TIFS_INTERNAL,
		.ra_idx				= AM62A_RA_IDX_SA3_SS0_RINGACC_0,
		.buffer_idx			= AM62A_SPROXY_MEM_IDX_DMSS_HSM_IPC_SRAM,
