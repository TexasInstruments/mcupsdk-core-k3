 ...
 *
 * SoC Data for Secure Proxy Instances for AM62P device
 *
...
const struct Sciserver_SecureProxy gSciserverSecureProxyInstances[SOC_MAX_SEC_PROXY_INSTANCES] = {
	/*
	 * [0] AM62PX_SPROXY_IDX_DMASS0_SEC_PROXY_0: Secure proxy instance:
	 * DMASS0_SEC_PROXY_0 linked to RA inst: DMASS0_RINGACC_0
	 */
	[AM62PX_SPROXY_IDX_DMASS0_SEC_PROXY_0] =	 {
		...
		.num_threads			= 76U,
		.devgrp				= SOC_DEVGRP_AM62PX_TIFS_INTERNAL,
		.ra_idx				= AM62PX_RA_IDX_DMASS0_RINGACC_0,
		.buffer_idx			= AM62PX_SPROXY_MEM_IDX_DMSS_IPC_SRAM,
