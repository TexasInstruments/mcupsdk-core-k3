...
const includes_a53 = {
    common: [
        "${MCU_PLUS_SDK_PATH}/source/eclipse_threadx/threadx/ports/ti_arm_gcc_clang_cortex_a53/inc",
        "${MCU_PLUS_SDK_PATH}/source/eclipse_threadx/threadx/threadx_src/common/inc",
        "${MCU_PLUS_SDK_PATH}/source/kernel/dpl",
        "${MCU_PLUS_SDK_PATH}/source/eclipse_threadx/threadx/dpl/common"
    ],
...
const includes_c75x = {
    common: [
        "${MCU_PLUS_SDK_PATH}/source/eclipse_threadx/threadx/ports/ti_arm_gcc_clang_cortex_c7x/inc",
        "${MCU_PLUS_SDK_PATH}/source/eclipse_threadx/threadx/threadx_src/common/inc",
        "${MCU_PLUS_SDK_PATH}/source/kernel/dpl",
        "${MCU_PLUS_SDK_PATH}/source/eclipse_threadx/threadx/dpl/common"
    ]
...
const filedirs_a53 = {
    common: [
        "${MCU_PLUS_SDK_PATH}/source/eclipse_threadx/threadx/threadx_src/common/src",
        "${MCU_PLUS_SDK_PATH}/source/eclipse_threadx/threadx/ports/ti_arm_gcc_clang_cortex_a53/src",
        "${MCU_PLUS_SDK_PATH}/source/eclipse_threadx/threadx/dpl/common",
        "${MCU_PLUS_SDK_PATH}/source/eclipse_threadx/threadx/dpl/a53",
        // picked from nortos DPL
...
const filedirs_c75x = {
    common: [
        "${MCU_PLUS_SDK_PATH}/source/eclipse_threadx/threadx/threadx_src/common/src",
        "${MCU_PLUS_SDK_PATH}/source/eclipse_threadx/threadx/ports/ti_arm_gcc_clang_cortex_c7x/src",
        "${MCU_PLUS_SDK_PATH}/source/eclipse_threadx/threadx/dpl/common",
        "${MCU_PLUS_SDK_PATH}/source/eclipse_threadx/threadx/dpl/c7x",
        // picked from nortos DPL
