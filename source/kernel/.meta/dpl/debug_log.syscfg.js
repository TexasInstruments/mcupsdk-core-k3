    ...
    let cfg = [
        {
            ...
            longDescription: "Used to enable error logs. When enabled, it logs all messages coming from DebugP_logError API.",
            default: true,
        },
        {
            name: "enableLogZoneWarning",
            displayName: "Enable Warning Log Zone",
            longDescription: "Used to enable warning logs. When enabled, it logs all messages coming from DebugP_logWarn API.",
            default: true,
        },
        {
            name: "enableLogZoneInfo",
            displayName: "Enable Info Log Zone",
            longDescription: "Used to enable information logs. When enabled, it logs all messages coming from DebugP_logInfo API.",
            default: false,
        },
        {
            name: "enableMemLog",
        ...
        },
        {
            ...
            description: "Used to enable logging via UART peripheral.",
            longDescription:
...
`,
        ...
        },
        {
            ...
            longDescription: `Uart used for remote core trace. Logs the message to UART console coming from remote cores.`,
            hidden : true,
            default : false,
        },
        {
            ...
            longDescription: `Uart used for sysfw trace logs. Logs the messages to UART console coming from system firmware`,
            hidden : false,
            default : false,
        },
        {
            ...
            longDescription: `Logs string to shared memory, some other core should have shared memory
        ...
        cfg.push(
            {
                name: "enableCssLog",
                displayName: "Enable CCS Log",
                longdescription: "Logs string to CCS console. When enabled, it prints all the logging messages on CCS console. This needs CCS and JTAG connected to the EVM.",
                default: true,
            });
    }
    return cfg;
