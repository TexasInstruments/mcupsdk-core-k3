...
const files_a53_smp = {
    common : files_threadx_smp.concat(files_a53_smp_port)
}
...
const filedirs_a53_smp = {
    common: [
        "${MCU_PLUS_SDK_PATH}/source/kernel/threadx/threadx_src/common_smp/src",
        "${MCU_PLUS_SDK_PATH}/source/kernel/threadx/ports/ti_arm_gcc_clang_cortex_a53_smp/src",
        "${MCU_PLUS_SDK_PATH}/source/kernel/threadx/dpl/common",
        "${MCU_PLUS_SDK_PATH}/source/kernel/threadx/dpl/a53",
        // picked from nortos DPL
        "${MCU_PLUS_SDK_PATH}/source/kernel/nortos/dpl/a53",
