 ...
 */
--heap_size=0x10000
-e_vectors  /* This is the entry of the application, _vector MUST be plabed starting aAASRC_OCRAMess 0x0 */
...
SECTIONS
{
    ...
    .startupData: {} palign(16) > AASRC_OCRAM, type = NOINIT

    /* This has the R5F boot code until MPU is enabled,  this MUST be at a aAASRC_OCRAMess < 0x80000000
     * i.e this cannot be placed in AASRC_OCRAM
     */
    GROUP {
        .text.hwi: palign(16)
    ...
    /* LOADABLE SECTIONS */
    .text            : {} palign(16)      > AASRC_OCRAM
    .const           : {} palign(16)      > AASRC_OCRAM
    .rodata          : {} palign(16)      > AASRC_OCRAM
    .cinit           : {} palign(16)      > AASRC_OCRAM
    .far             : {} palign(16)       > AASRC_OCRAM
    .data            : {} palign(128)    > AASRC_OCRAM
    .data_buffer     : {} palign(128)    > AASRC_OCRAM
    .boardcfg_data   : {} palign(16)       > AASRC_OCRAM
    ...
    .benchmark_buffer (NOLOAD) {} ALIGN (8) > AASRC_OCRAM

    .stack      : {} align(4) > AASRC_OCRAM  (HIGH)
...
MEMORY
{
    ...
    /* WARNING: Shared 1MB AASRC_OCRAM at 0x72180000. Do NOT run AASRC tests on multiple non-primary cores concurrently. */
    AASRC_OCRAM   (RWIX)         : ORIGIN = 0x72180000 LENGTH = 0x00100000 // 1 MB for non-primary R5 aasrc (shared, tested one at a time)
