...
SECTIONS
{
    ...
    /* LOADABLE SECTIONS */
    /* This is rest of code. This can be placed in AASRC_OCRAM if AASRC_OCRAM is available and needed */
    GROUP {
        .text:   {} palign(16)   /* This is where code resides */
        .rodata: {} palign(16)   /* This is where const's go */
    } > AASRC_OCRAM

    /* This is rest of initialized data. This can be placed in AASRC_OCRAM if AASRC_OCRAM is available and needed */
    GROUP {
    ...
    /* This is rest of uninitialized data. This can be placed in AASRC_OCRAM if AASRC_OCRAM is available and needed */
    GROUP {
