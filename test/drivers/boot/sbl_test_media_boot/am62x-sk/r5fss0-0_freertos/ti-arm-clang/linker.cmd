...
SECTIONS
{
    ...
    .cinit                  : {} palign(8)      > DDR
    .far                    : {} align(4)       > DDR
    /* Appimage buffers must be placed BEFORE generic .data to prevent capture */
    .data.appimage_buf0     : {} palign(128)    > APPIMAGE
    .data.appimage_buf1     : {} palign(128)    > APPIMAGE
    .data                   : {} palign(128)    > DDR
    .sysmem                 : {}                > DDR
    ...
    /* 25 MB scratch buffer — NOLOAD, placed BEFORE .bss to prevent capture */
...
MEMORY
{
    ...
    /* Appimage buffers for per-core IPC binaries embedded in appimage_data.S */
    APPIMAGE        (RWIX)      : ORIGIN = 0x84000000 LENGTH = 0x1900000
