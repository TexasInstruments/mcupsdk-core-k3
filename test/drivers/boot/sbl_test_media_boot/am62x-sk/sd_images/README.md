# SD Card Images for AM62X-SK Media Boot Test
...
|-----------|---------------------------------------------------------------------------------|------------------------------|
| app_a53   | examples/drivers/ipc/ipc_rpmsg_echo/am62x-sk/a53ss0-0_nortos/gcc-aarch64/      | A53 single-core appimage     |
| app_smp   | test/drivers/mmcsd/test_mmcsd_fs_io/am62x-sk/a53ss0-0_freertos-smp/gcc-aarch64 | A53 SMP appimage             |
| app_sys   | test/drivers/ipc_rpmsg/am62x-sk/system_freertos/                                | Multicore system appimage    |
...
1. Build the source examples:
   ```
   cd <SDK_ROOT>
   make ipc_rpmsg_echo BOARD=am62x-sk PROFILE=release
   make test_mmcsd_fs_io BOARD=am62x-sk PROFILE=release
   make test_ipc_rpmsg_system BOARD=am62x-sk PROFILE=release
   ```
