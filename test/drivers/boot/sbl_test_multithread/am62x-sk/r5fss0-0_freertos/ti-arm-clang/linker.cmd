...
SECTIONS
{
    ...
    /* Large appimage scratch buffer — must be placed BEFORE generic .bss to
     * prevent capture by the BSS GROUP below. NOLOAD: not stored in binary. */
...
MEMORY
{
    ...
    /* Appimage scratch buffer (25 MB) for bootloader authentication tests */
