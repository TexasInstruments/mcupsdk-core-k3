...
const filedirs_r5f = {
    common: [
        "..",       /* core_os_combo base */
        "../../..", /* Example base */
        "../../../../../../../../examples/drivers/boot/common/soc/am62dx/", /* sbl_ospi_stage2.c or sbl_emmc_stage2.c base */
    ],
};
...
/*
 * DDR buffer addresses where each core's individual appimage will be
 * pre-loaded for the multithread boot test (sbl_test_media_boot).
 * These addresses must match the APPIMAGE_BUF_* regions in the
 * sbl_test_media_boot linker script and the .cfg file entries.
 */
const appImageBufAddr = {
    "mcu-r5fss0-0": 0x86000000,
    "a53ss0-0":     0x86800000,
    "c75ss0-0":     0x87000000,
};

const appImageBufSize = 0x800000; /* 8 MB per buffer */
...
function getComponentBuildProperty(buildOption) {
    ...
    if(buildOption.cpu.match(/mcu-r5f*/))
    {
        ...
        build_property.appImageLoadAddr = 0x86000000;
    }
    else if(buildOption.cpu.match(/r5f*/))
    {
        ...
        build_property.appImageLoadAddr = 0x85000000;
    }
    else if(buildOption.cpu.match(/c75*/))
    {
        ...
        build_property.defines = defines_common;
        build_property.appImageLoadAddr = 0x87000000;
    }
    else if(buildOption.cpu.match(/a53*/))
    {
        ...
        if(buildOption.os.match("freertos-smp"))
        {
            ...
            build_property.appImageLoadAddr = 0x86800000;
        }
    }
