...
SECTIONS
{
    ...
    /* Large file receive / verify buffers — placed in dedicated DDR1 window */
...
MEMORY
{
    ...
    /* DDR1 for file receive/verify buffers [ size 64 MB ] */
    DDR1            (RWIX)      : ORIGIN = 0x84000000 LENGTH = 0x4000000
