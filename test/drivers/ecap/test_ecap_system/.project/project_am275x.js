...
/* R5F Master Specific Files (Mapped to R5FSS0-1) */
const files_r5_ecap = {
    common: [
        "system_test_utils.c",
        "test_ecap_system.c",
...
function getComponentProperty() {
    ...
    property.name = "test_ecap_system";
...
const robot_template = {
    ...
    options: {
        componentName: "ECAP",
        testCaseName: "ecap system test application",
        testCaseIds: "SITSW-10966 SITSW-10967 SITSW-10984",
        withCfg: true,
        cfgPath: "test/drivers/ecap/test_ecap_system/{board}/test_ecap_system_sbl_uart_${DEVICE_TYPE}.cfg",
        timeout: 300,
    },
};
...
function getComponentBuildProperty(buildOption) {
    ...
    {
        /* Master R5F Logic */
        build_property.files = files_r5_ecap;
    ...
    {
        /* Slave C75 Logic */
        build_property.files = files_c7_ecap;
    ...
    // r5fss0-1 is master core; attach robot template only to master to avoid duplicates
    if (buildOption.cpu === "r5fss0-1") {
