...
function getComponentProperty() {
    ...
    property.name = "test_epwm_system";
...
const robot_template = {
    ...
    options: {
        componentName: "EPWM",
        testCaseName: "epwm system test application",
        testCaseIds: "SITSW-11852 SITSW-11853 SITSW-11854",
        withCfg: true,
        cfgPath: "test/drivers/epwm/test_epwm_system/{board}/test_epwm_system_sbl_uart_${DEVICE_TYPE}.cfg",
        timeout: 300,
    },
};
...
function getComponentBuildProperty(buildOption) {
    ...
    {
        /* Master R5F Logic */
        build_property.files = files_r5_epwm;
    ...
    {
        /* Slave C75 Logic */
        build_property.files = files_c7_epwm;
