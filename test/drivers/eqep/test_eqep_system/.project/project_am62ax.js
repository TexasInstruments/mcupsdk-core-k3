...
const robot_template = {
    ...
    options: {
        componentName: "EQEP",
        testCaseName: "eqep driver system test application",
        appName: "test_eqep_system",
        testCaseIds: "SITSW-11993 SITSW-12208",
        withCfg: true,
        cfgPath: "test/drivers/eqep/test_eqep_system/{board}/test_eqep_system_sbl_uart_${DEVICE_TYPE}.cfg",
        timeout: 660,
        expectTimeout: 120,
    },
};
...
function getComponentProperty(device) {
    ...
    property.name = "test_eqep_system";
