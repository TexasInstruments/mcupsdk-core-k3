...
const includes = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/test/drivers/gpio/am62dx-evm",
    ],
};
...
const includes_nortos_dm_r5f = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/source/kernel/nortos/config/am62dx/r5f",
        "${MCU_PLUS_SDK_PATH}/test/unity/",
    ],
};
...
const robot_template = {
    ...
    options: {
        ...
        testCaseIds: "SITSW-1348 SITSW-1349 SITSW-1350 SITSW-1351 SITSW-9542 SITSW-9543 SITSW-9544 SITSW-9545 SITSW-9546 SITSW-9549 " +
            "SITSW-9550 SITSW-9637 SITSW-9916",
        expectTimeout: 120,
    },
};
...
function getComponentBuildProperty(buildOption) {
    ...
    if(buildOption.cpu.match(/mcu-r5f*/)) {
        ...
        {
            build_property.files = files_r5f_rtos;
