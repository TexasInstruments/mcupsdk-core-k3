...
/*
 includes from source drivers
*/
const includes_r5f = buildProperty_r5f.includes;
...
function getComponentBuildProperty(buildOption) {
    ...
    if(buildOption.cpu.match(/wkup-r5f*/))
    {
        ...
        if(includes_wkup_r5f) build_property.includes = includes_wkup_r5f;
    }
    else if(buildOption.cpu.match(/r5f*/))
    {
        ...
        if(includes_r5f) build_property.includes = includes_r5f;
    }
