...
function getComponentProperty() {
    ...
    property.name = "test_ipc_rpmsg_linux";
    property.linuxAppName = "test_ipc_rpmsg";
...
const robot_template = {
    ...
    options: {
        componentName: "IPC",
        testCaseName: "ipc_rpmsg_linux test application",
        appName: "test_ipc_rpmsg_linux",
        testCaseIds: "SITSW-9979",
        withCfg: true,
        cfgPath: "test/drivers/ipc_rpmsg_linux/{board}/ipc_rpmsg_test_sbl_uart_${DEVICE_TYPE}.cfg",
    },
};
