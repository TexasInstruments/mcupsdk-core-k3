...
[
    {
        input: "test/drivers/ipc_rpmsg_mcal/ipc_rpmsg_mcal_Vring_1_Test/.project/templates/am62ax/common/linker_dm_r5f.cmd.xdt",
        output: "linker.cmd",
        options: {
            heapSize: 0x8000,
            stackSize: 0x4000,
    ...
    {
        input: "test/drivers/ipc_rpmsg_mcal/ipc_rpmsg_mcal_Vring_1_Test/.project/templates/am62ax/freertos/main_freertos_dm.c.xdt",
        output: "../main.c",
        options: {
...
[
    {
        input: "test/drivers/ipc_rpmsg_mcal/ipc_rpmsg_mcal_Vring_1_Test/.project/templates/am62ax/common/linker_mcu-r5f.cmd.xdt",
        output: "linker.cmd",
    },
    {
        input: "test/drivers/ipc_rpmsg_mcal/ipc_rpmsg_mcal_Vring_1_Test/.project/templates/am62ax/freertos/main_freertos.c.xdt",
        output: "../main.c",
        options: {
            entryFunction: "test_main",
        },
...
[
    {
        input: "test/drivers/ipc_rpmsg_mcal/ipc_rpmsg_mcal_Vring_1_Test/.project/templates/am62ax/common/linker_c75.cmd.xdt",
        output: "linker.cmd",
    },
    {
        input: "test/drivers/ipc_rpmsg_mcal/ipc_rpmsg_mcal_Vring_1_Test/.project/templates/am62ax/freertos/main_freertos.c.xdt",
...
[
    {
        input: "test/drivers/ipc_rpmsg_mcal/ipc_rpmsg_mcal_Vring_1_Test/.project/templates/am62ax/common/linker_a53.cmd.xdt",
        output: "linker.cmd",
    },
    {
        input: "test/drivers/ipc_rpmsg_mcal/ipc_rpmsg_mcal_Vring_1_Test/.project/templates/am62ax/freertos/main_freertos.c.xdt",
...
function getComponentProperty() {
    ...
    property.name = "test_ipc_rpmsg_vring_1";
