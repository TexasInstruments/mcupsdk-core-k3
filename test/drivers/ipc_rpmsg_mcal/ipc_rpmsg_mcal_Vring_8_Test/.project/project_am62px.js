...
[
    {
        input: "test/drivers/ipc_rpmsg_mcal/ipc_rpmsg_mcal_Vring_8_Test/.project/templates/am62px/common/linker_wkup-r5f.cmd.xdt",
        output: "linker.cmd",
        options: {
            heapSize: 0x10000,
            stackSize: 0x8000,
    ...
    {
        input: "test/drivers/ipc_rpmsg_mcal/ipc_rpmsg_mcal_Vring_8_Test/.project/templates/am62px/freertos/main_freertos_dm.c.xdt",
        output: "../main.c",
        options: {
...
[
    {
        input: "test/drivers/ipc_rpmsg_mcal/ipc_rpmsg_mcal_Vring_8_Test/.project/templates/am62px/common/linker_mcu-r5f.cmd.xdt",
        output: "linker.cmd",
    },
    {
        input: "test/drivers/ipc_rpmsg_mcal/ipc_rpmsg_mcal_Vring_8_Test/.project/templates/am62px/freertos/main_freertos.c.xdt",
        output: "../main.c",
        options: {
            entryFunction: "test_main",
        },
