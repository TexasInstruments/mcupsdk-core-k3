...
[
    {
        input: "test/drivers/ipc_rpmsg_mcal_Multiple_End_Point_Test/.project/templates/am62x/common/linker_dm_r5f.cmd.xdt",
        output: "linker.cmd",
        options: {
            heapSize: 0x10000,
            stackSize: 0x8000,
    ...
    {
        input: "test/drivers/ipc_rpmsg_mcal_Multiple_End_Point_Test/.project/templates/am62x/freertos/main_freertos_dm.c.xdt",
        output: "../main.c",
        options: {
...
[
    {
        input: "test/drivers/ipc_rpmsg_mcal_Multiple_End_Point_Test/.project/templates/am62x/common/linker_m4f.cmd.xdt",
        output: "linker.cmd",
    },
    {
        input: "test/drivers/ipc_rpmsg_mcal_Multiple_End_Point_Test/.project/templates/am62x/freertos/main_freertos.c.xdt",
        output: "../main.c",
        options: {
            entryFunction: "test_main",
        },
...
[
    {
        input: "test/drivers/ipc_rpmsg_mcal_Multiple_End_Point_Test/.project/templates/am62x/common/linker_a53ss0-0.cmd.xdt",
        output: "linker.cmd",
    },
    {
        input: "test/drivers/ipc_rpmsg_mcal_Multiple_End_Point_Test/.project/templates/am62x/freertos/main_freertos.c.xdt",
...
[
    {
        input: "test/drivers/ipc_rpmsg_mcal_Multiple_End_Point_Test/.project/templates/am62x/common/linker_a53ss0-1.cmd.xdt",
        output: "linker.cmd",
    },
    {
        input: "test/drivers/ipc_rpmsg_mcal_Multiple_End_Point_Test/.project/templates/am62x/freertos/main_freertos.c.xdt",
