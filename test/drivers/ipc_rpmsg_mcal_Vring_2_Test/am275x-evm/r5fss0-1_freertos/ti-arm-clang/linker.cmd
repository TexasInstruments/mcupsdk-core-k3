...
SECTIONS
{
    ...
    /* This is rest of code. This can be placed in R50_1_OCRAM if R50_1_OCRAM is available and needed */
    GROUP {
    ...
    /* This is rest of initialized data. This can be placed in R50_1_OCRAM if R50_1_OCRAM is available and needed */
    GROUP {
        .data:   {} palign(8)   /* This is where initialized globals and static go */
    } > R50_1_OCRAM

    /* This is rest of uninitialized data. This can be placed in R50_1_OCRAM if R50_1_OCRAM is available and needed */
    GROUP {
...
MEMORY
{
    ...
    C75_1_OCRAM   (RWIX)         : ORIGIN = 0x72490000 LENGTH = 0x00080000 // 512 KB for c75ss1-0 core

    LOG_SHM_MEM                  : ORIGIN = 0x72380000, LENGTH = 0x40000
    IPC_VRING_RTOS               : ORIGIN = 0x723C0000, LENGTH = 0xc0000   /* IPC VRING for RTOS/NoRTOS */
