...
const cflags_freertos_dm_r5f = {
    common: [
        "-DENABLE_MT_TESTS",
        "-DAPP_MCASP_TASK_STACK_SIZE_MT=0x1000"   // 4*1024
    ],
}
...
const libs_freertos_dm_r5f = {
    common: [
        ...
        "drivers-mcasp-inject-fault.am62ax.dm-r5f.ti-arm-clang.${ConfigName}.lib",
...
const libs_freertos_a53 = {
    common: [
        ...
        "drivers-mcasp-inject-fault.am62ax.a53.gcc-aarch64.${ConfigName}.lib",
