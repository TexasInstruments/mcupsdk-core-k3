...
const robot_template = {
    ...
    options: {
        ...
        testCaseIds: "SITSW-2894 SITSW-2895 SITSW-2901 SITSW-2902 SITSW-2903 SITSW-2904 SITSW-2905 SITSW-2906 SITSW-2908 SITSW-2910" +
                     ...
                     " SITSW-8055 SITSW-8056 SITSW-8057 SITSW-10724",
        timeout: 2400,
        expectTimeout: 500,
    },
};
...
function getComponentBuildProperty(buildOption) {
    ...
    if(buildOption.cpu.match(/r5f*/)) {
        ...
        if(buildOption.os.match(/freertos*/)) {
            build_property.files = files_freertos_m4f;
            build_property.defines = defines_freertos_m4f;
