...
function getComponentBuildProperty(buildOption) {
    ...
    {
        build_property.files = files_r5_dummy;
    ...
    {
        build_property.files = files_a53_master;
    ...
    {
        build_property.files = files_m4_slave;
