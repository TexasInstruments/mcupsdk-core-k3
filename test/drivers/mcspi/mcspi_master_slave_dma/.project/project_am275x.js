...
/* R5F Slave Specific Files (Mapped to R5FSS0-1) */
const files_r5_slave = {
    common: [
        "system_test_utils.c",
        "test_case_mapping.c",
        "test_mcspi_slave_dma.c",
        "main.c",
    ],
};

/* Common files for C75 */
const files_c7_master = {
    common: [
        "system_test_utils.c",
        "test_case_mapping.c",
        "test_mcspi_master_dma.c",
        "main.c",
    ],
};
...
function getComponentProperty() {
    ...
    property.name = "test_mcspi_master_slave_dma";
...
function getComponentBuildProperty(buildOption) {
    ...
    {
        /* Master R5F Logic */
        build_property.files = files_r5_slave;
    ...
    {
        /* Common C75 Logic (Cluster 0) */
        build_property.files = files_c7_master;
