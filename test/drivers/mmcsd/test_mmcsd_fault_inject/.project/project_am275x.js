...
const libs_freertos_wkup_r5f = {
    common: [
        ...
        "drivers-mmcsd-inject-fault.am275x.wkup-r5f.ti-arm-clang.${ConfigName}.lib",
...
const libs_freertos_r5f = {
    common: [
        "freertos.am275x.r5f.ti-arm-clang.${ConfigName}.lib",
        "drivers-mmcsd-inject-fault.am275x.r5f.ti-arm-clang.${ConfigName}.lib",
        "board.am275x.r5f.ti-arm-clang.${ConfigName}.lib",
        "unity.am275x.r5f.ti-arm-clang.${ConfigName}.lib",
    ],
};
...
const libs_freertos_c75 = {
    common: [
        ...
        "drivers-mmcsd-inject-fault.am275x.c75x.ti-c7000.${ConfigName}.lib",
