 ...
 */
--heap_size=0x10000
--entry_point=_self_reset_start  /* This is the entry of the application, _vector MUST be plabed starting address 0x0 */
...
SECTIONS
{
    ...
    .startupCode:{} palign(8), load = R5F_TCMB, run = R5F_TCMA
    .startupData: {} palign(8), load = R5F_TCMB, run = R5F_TCMA, type = NOINIT
    ...
    .const.devgroup  : { *(.const.devgroup*) } align(4) > WKUP_R5_OCRAM
...
MEMORY
{
    ...
    WKUP_R5_OCRAM (RWIX)         : ORIGIN = 0x72000000 LENGTH = 0x000A0000 // 640 KB for wakeup core
