...
[
    {
        input: ".project/templates/am62ax/common/linker_a53_smp_ospi.cmd.xdt",
        output: "linker.cmd",
        options: {
            globalScratchBuf: "true",
            globalScratchBufSize: 0x8000000,
...
function getComponentBuildProperty(buildOption) {
    ...
    if(buildOption.cpu.match(/mcu-r5f*/)){
        if(buildOption.os.match(/freertos*/) )
        {
            ...
            build_property.cflags = cflags_mcur5f_freertos;
        }
        else
        {
            ...
            build_property.cflags = cflags_mcur5f_nortos;
        }
    }
