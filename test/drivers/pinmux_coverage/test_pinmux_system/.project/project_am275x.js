 ...
 * Attached to r5fss0-1 only (master test runner that includes
 * test_pinmux_system.c); all other cores are support cores. */
...
function getComponentBuildProperty(buildOption) {
    ...
    // r5fss0-1 is master core; robot only for master
    if (buildOption.cpu.match(/^r5fss0-1$/)) {
