 ...
 * Attached to mcu-r5fss0-0 only (master test runner); other cores are
 * support cores and must not generate a duplicate robot entry. */
...
function getComponentBuildProperty(buildOption) {
    ...
    // mcu-r5fss0-0 is master core; robot only for master
