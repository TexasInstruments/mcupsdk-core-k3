...
const templates_freertos_mcur5 =
[
    {
...
function getComponentBuildProperty(buildOption) {
    ...
    if (buildOption.cpu.match(/mcu-r5f*/)) {
        ...
        build_property.libdirs = libdirs_freertos_mcur5;
        build_property.libs = libs_freertos_mcur5;
        build_property.templates = templates_freertos_mcur5;
