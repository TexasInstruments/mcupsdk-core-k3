...
const libdirs_freertos_dm_r5 = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/source/drivers/lib",
        "${MCU_PLUS_SDK_PATH}/test/unity/lib",
        "${MCU_PLUS_SDK_PATH}/test/drivers/uart/am62ax-evm",
...
const libs_freertos_mcu_r5f = {
    common: [
        ...
        "drivers-uart-inject-fault.am62ax.r5f.ti-arm-clang.${ConfigName}.lib",
...
const libs_freertos_dm_r5f = {
    common: [
        "freertos.am62ax.r5f.ti-arm-clang.${ConfigName}.lib",
        "unity.am62ax.r5f.ti-arm-clang.${ConfigName}.lib",
        "drivers-uart-inject-fault.am62ax.dm-r5f.ti-arm-clang.${ConfigName}.lib",
        "board.am62ax.r5f.ti-arm-clang.${ConfigName}.lib",
    ],
};
...
const libs_freertos_a53 = {
    common: [
        ...
        "drivers-uart-inject-fault.am62ax.a53.gcc-aarch64.${ConfigName}.lib",
...
function getComponentProperty() {
    ...
    property.name = "test_uart_fault_inject";
...
const robot_template = {
    ...
    options: {
        componentName: "UART",
        testCaseName: "UART Fault Inject Test Application",
        testCaseIds: "SITSW-10149 SITSW-10150 SITSW-10151 SITSW-10152",
        expectTimeout: 60,
    },
};
...
function getComponentBuildProperty(buildOption) {
    ...
    if(buildOption.cpu.match(/mcu-r5f*/)) {
        ...
        if(buildOption.os.match(/freertos*/) ) {
            ...
            build_property.cflags = cflags_free_rtos_dm_r5;
        }
        else {
            ...
            build_property.cflags = cflags_no_rtos_dm_r5;
        }
    }
        ...
        if(buildOption.os.match(/freertos*/) )
        {
            ...
            build_property.cflags = cflags_free_rtos_a53;
        }
        else {
