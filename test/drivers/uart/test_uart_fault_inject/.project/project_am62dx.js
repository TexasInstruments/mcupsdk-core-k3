...
const libdirs_freertos_dm_r5 = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/test/unity/lib",
        "${MCU_PLUS_SDK_PATH}/test/drivers/uart/am62dx-evm",
...
const libs_r5f = {
    common: [
        ...
        "drivers-uart-inject-fault.am62dx.r5f.ti-arm-clang.${ConfigName}.lib",
    ],
};
...
const libs_prebuild_nortos = {
    common: [
        ...
        "drivers-uart-inject-fault.am62dx.dm-r5f.ti-arm-clang.${ConfigName}.lib",
    ]
};
...
const libs_a53 = {
    common: [
        ...
        "drivers-uart-inject-fault.am62dx.a53.gcc-aarch64.${ConfigName}.lib",
    ],
};
