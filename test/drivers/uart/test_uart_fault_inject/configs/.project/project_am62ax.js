...
const buildProperty_a53 = require('../../../../../../source/drivers/.project/project_am62ax.js').getComponentBuildProperty(buildOptionCombos[0]);
const buildProperty_r5f = require('../../../../../../source/drivers/.project/project_am62ax.js').getComponentBuildProperty(buildOptionCombos[1]);
const buildProperty_mcu = require('../../../../../../source/drivers/.project/project_am62ax.js').getComponentBuildProperty(buildOptionCombos[2]);
...
function getComponentProperty() {
    ...
    property.name = "drivers-uart-inject-fault";
