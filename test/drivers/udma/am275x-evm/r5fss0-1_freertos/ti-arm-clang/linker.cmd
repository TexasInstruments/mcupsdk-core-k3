...
SECTIONS
{
    ...
    /* Move code to shared OCRAM since R50_1_OCRAM (512KB) is insufficient for this binary */
    GROUP {
        .text:   {} palign(8)   /* This is where code resides */
        .rodata: {} palign(8)   /* This is where const's go */
    } > OCRAM

    /* Move data to shared OCRAM since R50_1_OCRAM (512KB) is insufficient for this binary */
    GROUP {
