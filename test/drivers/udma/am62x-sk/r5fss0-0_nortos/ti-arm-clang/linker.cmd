...
SECTIONS
{
    ...
    .udma_buffer_ddr      (NOLOAD) : {} align(8) > DDR_UDMA
    .udma_buffer_msmc     (NOLOAD) : {} align(8) > DDR_UDMA
    .udma_buffer_internal (NOLOAD) : {} align(8) > DDR_UDMA
    .udma_buffer_ospi     (NOLOAD) : {} align(8) > DDR_UDMA
...
MEMORY
{
    ...
    DDR_UDMA       (RWIX)      : ORIGIN = 0x90000000, LENGTH = 0x8000000
}
