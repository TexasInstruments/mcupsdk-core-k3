...
const libs_freertos_mcu_r5f = {
    common: [
        ...
        "drivers-udma-inject-fault.am62px.mcu-r5f.ti-arm-clang.${ConfigName}.lib",
...
const libs_freertos_wkup_r5f = {
    common: [
        ...
        "freertos.am62px.r5f.ti-arm-clang.${ConfigName}.lib",
        "drivers-udma-inject-fault.am62px.wkup-r5f.ti-arm-clang.${ConfigName}.lib",
        "board.am62px.r5f.ti-arm-clang.${ConfigName}.lib",
...
const defines_freertos_wkup_r5f = {
    common: [
        "SOC_AM62PX",
        "ENABLE_SCICLIENT_DIRECT",
        "ENABLE_MT_TESTS",
...
function getComponentBuildProperty(buildOption) {
    ...
    if (buildOption.cpu.match(/mcu-r5f*/)) {
        ...
        if (buildOption.os.match(/freertos*/)) {
            ...
            build_property.defines = defines_freertos_wkup_r5f;
        } else {
            build_property.includes = includes;
