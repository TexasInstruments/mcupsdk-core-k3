...
const buildProperty_a53 = require('../../../../../../source/drivers/.project/project_am62x.js').getComponentBuildProperty(buildOptionCombos[0]);
const buildProperty_r5f = require('../../../../../../source/drivers/.project/project_am62x.js').getComponentBuildProperty(buildOptionCombos[1]);
const buildProperty_mcu = buildProperty_r5f;
...
*/
const defines_a53 = buildProperty_a53.defines ? buildProperty_a53.defines : { common: [] }
const defines_r5f = buildProperty_r5f.defines ? buildProperty_r5f.defines : { common: [] }
const defines_mcu = buildProperty_mcu.defines ? buildProperty_mcu.defines : { common: [] }
/*
