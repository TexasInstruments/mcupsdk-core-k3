...
const robot_template = {
    ...
    options: {
        ...
        testCaseIds: "SITSW-1235 SITSW-1262 SITSW-1263 SITSW-1264 SITSW-1265 SITSW-1266 SITSW-1267 SITSW-1268 SITSW-1269 SITSW-1270" +
                     " SITSW-1271 SITSW-1272 SITSW-1273 SITSW-1274 SITSW-1277 SITSW-1278 SITSW-1455 SITSW-4735 SITSW-7111 SITSW-12055" +
                     " SITSW-12504",
        timeout: 630,
    },
};
...
function getComponentBuildProperty(buildOption) {
    ...
    if(buildOption.cpu.match(/mcu-r5f*/)) {
        ...
        if(buildOption.os.match(/freertos*/) )
        {
            ...
            build_property.defines = defines_freertos_dm_r5;
        }
    }
