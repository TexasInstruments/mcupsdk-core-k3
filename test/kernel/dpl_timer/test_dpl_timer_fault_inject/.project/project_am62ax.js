...
const files = {
    common: [
        "main.c",
        "test_dpl_timer_fault_injection.c",
    ],
};
...
const includes_freertos_mcu_r5f = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/test/kernel/dpl_timer/",
    ],
};
...
const libs_freertos_mcu_r5f = {
    common: [
        "freertos-dpl-timer-inject-fault.am62ax.r5f.ti-arm-clang.${ConfigName}.lib",
...
const libs_freertos_a53 = {
    common: [
        "freertos-dpl-timer-inject-fault.am62ax.a53.gcc-aarch64.${ConfigName}.lib",
...
const libs_r5f = {
    common: [
        "nortos-dpl-timer-inject-fault.am62ax.r5f.ti-arm-clang.${ConfigName}.lib",
        "unity.am62ax.r5f.ti-arm-clang.${ConfigName}.lib",
        "drivers.am62ax.r5f.ti-arm-clang.${ConfigName}.lib",
    ],
};
...
const libs_a53 = {
    common: [
        "nortos-dpl-timer-inject-fault.am62ax.a53.gcc-aarch64.${ConfigName}.lib",
        "unity.am62ax.a53.gcc-aarch64.${ConfigName}.lib",
        "drivers.am62ax.a53.gcc-aarch64.${ConfigName}.lib",
    ],
};
...
function getComponentProperty() {
    ...
    property.name = "test_dpl_timer_fault_inject";
