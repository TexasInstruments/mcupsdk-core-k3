...
const buildProperty_a53 = require('../../../../../../source/kernel/freertos/.project/project_am62dx.js').getComponentBuildProperty(buildOptionCombos[0]);
const buildProperty_c75x = require('../../../../../../source/kernel/freertos/.project/project_am62dx.js').getComponentBuildProperty(buildOptionCombos[1]);
const buildProperty_mcu = require('../../../../../../source/kernel/freertos/.project/project_am62dx.js').getComponentBuildProperty(buildOptionCombos[2]);
...
const defines_r5 = buildProperty_mcu.defines;
const defines_c7x = buildProperty_c75x.defines;
