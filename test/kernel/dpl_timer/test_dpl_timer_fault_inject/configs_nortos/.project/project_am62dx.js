...
const dir = "${MCU_PLUS_SDK_PATH}/source/kernel/nortos/"
...
const buildProperty_a53 = require('../../../../../../source/kernel/nortos/.project/project_am62dx.js').getComponentBuildProperty(buildOptionCombos[0]);
const buildProperty_mcu = require('../../../../../../source/kernel/nortos/.project/project_am62dx.js').getComponentBuildProperty(buildOptionCombos[1]);
...
function getComponentProperty() {
    ...
    property.name = "nortos-dpl-timer-inject-fault";
