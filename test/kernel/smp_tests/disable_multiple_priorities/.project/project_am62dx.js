...
const files_a53 = {
    common: [
        "test_disable_multiple_priorities.c",
        "main.c",
    ],
};
...
const includes_a53 = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/test/kernel/smp_tests/disable_multiple_priorities",
...
const libs_a53 = {
    common: [
        "freertos-smp-disable-multiple-priorities.am62dx.a53-smp.gcc-aarch64.${ConfigName}.lib",
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "test_disable_multiple_priorities_main",
...
function getComponentProperty() {
    ...
    property.name = "test_disable_multiple_priorities";
