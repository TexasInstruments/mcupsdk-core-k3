...
const files_a53 = {
    common: [
        "test_interrupt_wait_critical.c",
        "main.c",
    ],
};
...
const includes_a53 = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/test/kernel/smp_tests/interrupt_wait_critical",
...
const libs_a53 = {
    common: [
        "freertos-smp-interrupt-wait-critical.am62ax.a53-smp.gcc-aarch64.${ConfigName}.lib",
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "test_interrupt_wait_critical_main",
...
function getComponentProperty() {
    ...
    property.name = "test_interrupt_wait_critical";
