...
const includes_a53 = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/test/kernel/smp_tests/multiple_tasks_running",
...
const libs_a53 = {
    common: [
        "freertos-smp-multiple-tasks-running.am62dx.a53-smp.gcc-aarch64.${ConfigName}.lib",
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "test_multiple_tasks_running",
...
function getComponentProperty() {
    ...
    property.name = "test_multiple_tasks_running";
