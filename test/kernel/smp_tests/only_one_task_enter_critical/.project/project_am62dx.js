...
const files_a53 = {
    common: [
        "test_only_one_task_enter_critical.c",
        "main.c",
    ],
};
...
const includes_a53 = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/test/kernel/smp_tests/only_one_task_enter_critical",
...
const libs_a53 = {
    common: [
        "freertos-smp-only-one-task-enter-critical.am62dx.a53-smp.gcc-aarch64.${ConfigName}.lib",
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "test_only_one_task_enter_critical_main",
...
function getComponentProperty() {
    ...
    property.name = "test_only_one_task_enter_critical";
