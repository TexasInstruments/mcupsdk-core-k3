...
const buildProperty = require('../../../../../../source/kernel/freertos/.project/project_am62x.js').getComponentBuildProperty(buildOptionCombos[0]);
...
*/
includes.common = includes.common.filter(path => path !== "config/am62x/a53-smp");
...
function getComponentProperty() {
    ...
    property.name = "freertos-smp-only-one-task-enter-suspendall";
