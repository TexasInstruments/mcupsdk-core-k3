...
const files_a53 = {
    common: [
        "test_schedule_equal_priority.c",
        "main.c",
    ],
};
...
const includes_a53 = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/test/kernel/smp_tests/schedule_equal_priority",
...
const libs_a53 = {
    common: [
        "freertos-smp-schedule-equal-priority.am62ax.a53-smp.gcc-aarch64.${ConfigName}.lib",
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "test_schedule_equal_priority_main",
...
function getComponentProperty() {
    ...
    property.name = "test_schedule_equal_priority";
