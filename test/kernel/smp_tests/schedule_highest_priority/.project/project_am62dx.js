...
const files_a53 = {
    common: [
        "test_schedule_highest_priority.c",
        "main.c",
    ],
};
...
const includes_a53 = {
    common: [
        ...
        "${MCU_PLUS_SDK_PATH}/test/kernel/smp_tests/schedule_highest_priority",
...
const libs_a53 = {
    common: [
        "freertos-smp-schedule-highest-priority.am62dx.a53-smp.gcc-aarch64.${ConfigName}.lib",
...
[
    ...
    },
    {
        ...
        output: "../main.c",
        options: {
            entryFunction: "test_schedule_highest_priority_main",
...
function getComponentProperty() {
    ...
    property.name = "test_schedule_highest_priority";
