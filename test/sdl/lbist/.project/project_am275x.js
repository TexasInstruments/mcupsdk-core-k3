...
function getComponentBuildProperty(buildOption) {
    ...
    if(buildOption.cpu.match(/r5f*/)) {
        ...
        {
            build_property.files = files_freertos_r5;
            build_property.filedirs = filedirs_freertos_r5;
        ...
        {
            build_property.files = files_nortos_r5;
            build_property.filedirs = filedirs_nortos_r5;
